...
requestOptions.uri = 'https://api.emea1b.fenergox.com/identitymanagementquery/api/users';
...
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.emea1b.fenergox.com/identitymanagementquery/api/users/{id}'.replace('{id}', id);

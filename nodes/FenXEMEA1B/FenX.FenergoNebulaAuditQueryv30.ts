...
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.emea1b.fenergox.com/auditquery/api/v3/self-service-management/selfServiceUserManagementEvents';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'GetSelfServiceClientSecretManagementEventsV3': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.emea1b.fenergox.com/auditquery/api/v3/self-service-management/selfServiceClientSecretManagementEvents';

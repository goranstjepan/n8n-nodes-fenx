...
versionNumber = base.getNodeParameter('versionNumber', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.emea1b.fenergox.com/policyquery/api/v2/requirement-set/{setId}/version/{versionNumber}/light'.replace('{setId}', setId).replace('{versionNumber}', versionNumber);
...
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.emea1b.fenergox.com/policyquery/api/v2/requirement-set/{versionId}/requirements'.replace('{versionId}', versionId);

...
async function ExecuteFenergoNebulaCollateralQueryv10(base: IExecuteFunctions): Promise < INodeExecutionData[][] > {
    ...
    let id=''; let collateralId=''; let journeyId=''; let taskId=''; let assetDraftId=''; let assetId=''; let entityId=''; let collateralDraftId='';
switch(endpoint){ case 'GetAssetById': id = base.getNodeParameter('id', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.emea1b.fenergox.com/collateralquery/api/asset/{id}'.replace('{id}', id);

break;
case 'GetAssetsList': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.emea1b.fenergox.com/collateralquery/api/asset/getAssetsList';
...
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.emea1b.fenergox.com/collateralquery/api/asset/collateral/{collateralId}/journey/{journeyId}/task/{taskId}/snapshot'.replace('{collateralId}', collateralId).replace('{journeyId}', journeyId).replace('{taskId}', taskId);

break;
case 'GetAssetDraftById': assetDraftId = base.getNodeParameter('assetDraftId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.emea1b.fenergox.com/collateralquery/api/asset/draft/{assetDraftId}'.replace('{assetDraftId}', assetDraftId);
...
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.emea1b.fenergox.com/collateralquery/api/asset/draft/{assetId}/{assetDraftId}'.replace('{assetDraftId}', assetDraftId).replace('{assetId}', assetId);

break;
case 'GetAssetDraftByIds': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.emea1b.fenergox.com/collateralquery/api/asset/draft/list';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'GetAssetDraftsByJourney': journeyId = base.getNodeParameter('journeyId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.emea1b.fenergox.com/collateralquery/api/asset/draft/journey/{journeyId}'.replace('{journeyId}', journeyId);

break;
case 'GetCollaterals': 
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.emea1b.fenergox.com/collateralquery/api/collateral';

break;
case 'GetCollateralById': id = base.getNodeParameter('id', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.emea1b.fenergox.com/collateralquery/api/collateral/{id}'.replace('{id}', id);

break;
case 'GetCollateralsList': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.emea1b.fenergox.com/collateralquery/api/collateral/getCollateralsList';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'GetCollateralsSnapShot': journeyId = base.getNodeParameter('journeyId', 0) as string;
taskId = base.getNodeParameter('taskId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.emea1b.fenergox.com/collateralquery/api/collateral/journey/{journeyId}/task/{taskId}/snapshot'.replace('{journeyId}', journeyId).replace('{taskId}', taskId);

break;
case 'ValidateDealCollateralAllocation': journeyId = base.getNodeParameter('journeyId', 0) as string;
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.emea1b.fenergox.com/collateralquery/api/collateral/journey/{journeyId}/validateAllocation'.replace('{journeyId}', journeyId);

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'GetRelatedCollateralDataSource': entityId = base.getNodeParameter('entityId', 0) as string;
journeyId = base.getNodeParameter('journeyId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.emea1b.fenergox.com/collateralquery/api/collateral/related-collateral/entity/{entityId}/journey/{journeyId}'.replace('{entityId}', entityId).replace('{journeyId}', journeyId);

break;
case 'GetCollateralDraftById': collateralDraftId = base.getNodeParameter('collateralDraftId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.emea1b.fenergox.com/collateralquery/api/collateral/draft/{collateralDraftId}'.replace('{collateralDraftId}', collateralDraftId);
...
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.emea1b.fenergox.com/collateralquery/api/collateral/draft/{collateralId}/{collateralDraftId}'.replace('{collateralDraftId}', collateralDraftId).replace('{collateralId}', collateralId);

break;
case 'GetCollateralDraftByIds': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.emea1b.fenergox.com/collateralquery/api/collateral/draft/list';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'GetCollateralDraftsByJourney': journeyId = base.getNodeParameter('journeyId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.emea1b.fenergox.com/collateralquery/api/collateral/draft/journey/{journeyId}'.replace('{journeyId}', journeyId);

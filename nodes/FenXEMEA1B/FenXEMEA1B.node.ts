...
import { FenergoNebulaPortalAPIv1000Properties, ExecuteFenergoNebulaPortalAPIv1000 } from './FenX.FenergoNebulaPortalAPIv1000';
...
export class FenXEMEA1B implements INodeType {
	description: INodeTypeDescription = {
		displayName: 'Fenergo EMEA1B',
		name: 'fenXEMEA1B',
		icon: 'file:FenX.png',
		group: ['transform'],
		version: 1,
		description: 'Consume Fenergo APIs EMEA1B',
		defaults: {
			name: 'Fenergo EMEA1B',
			color: '#1A82e2',
		},
...
.concat(FenergoNebulaPortalAPIv1000Properties)
...
case 'FenergoNebulaPortalAPIv1000': return await ExecuteFenergoNebulaPortalAPIv1000(this);

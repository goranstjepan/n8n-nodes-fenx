...
requestOptions.uri = 'https://api.emea1b.fenergox.com/creditassessmentquery/api/auto';

break;
case 'GetAutomatedCreditAssessmentById': id = base.getNodeParameter('id', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.emea1b.fenergox.com/creditassessmentquery/api/auto/{id}'.replace('{id}', id);

break;
case 'GetAutomatedCreditAssessmentSnapshotById': id = base.getNodeParameter('id', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.emea1b.fenergox.com/creditassessmentquery/api/auto/{id}/snapshot'.replace('{id}', id);
...
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.emea1b.fenergox.com/creditassessmentquery/api/auto/entity/{entityId}/journey/{journeyId}/task/{taskId}'.replace('{entityId}', entityId).replace('{journeyId}', journeyId).replace('{taskId}', taskId);

break;
case 'GetAutomatedCreditAssessmentByJourneyId': journeyId = base.getNodeParameter('journeyId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.emea1b.fenergox.com/creditassessmentquery/api/auto/journey/{journeyId}'.replace('{journeyId}', journeyId);

break;
case 'GetCreditAssessmentSetById': setId = base.getNodeParameter('setId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.emea1b.fenergox.com/creditassessmentquery/api/creditassessment/set/{setId}'.replace('{setId}', setId);

break;
case 'GetCreditAssessmentSetByJourneyId': journeyId = base.getNodeParameter('journeyId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.emea1b.fenergox.com/creditassessmentquery/api/creditassessment/set/journey/{journeyId}'.replace('{journeyId}', journeyId);

break;
case 'GetCreditAssessmentById': assessmentId = base.getNodeParameter('assessmentId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.emea1b.fenergox.com/creditassessmentquery/api/creditassessment/assessment/{assessmentId}'.replace('{assessmentId}', assessmentId);

break;
case 'GetCreditAssessmentByTaskId': taskId = base.getNodeParameter('taskId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.emea1b.fenergox.com/creditassessmentquery/api/creditassessment/assessment/task/{taskId}'.replace('{taskId}', taskId);
...
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.emea1b.fenergox.com/creditassessmentquery/api/creditassessment/assessment/{assessmentId}/version/{versionNumber}/snapshot'.replace('{assessmentId}', assessmentId).replace('{versionNumber}', versionNumber);

break;
case 'GetHistoryByJourneyId': journeyId = base.getNodeParameter('journeyId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.emea1b.fenergox.com/creditassessmentquery/api/creditassessment/journey/{journeyId}/history'.replace('{journeyId}', journeyId);

break;
case 'GetHistorySnapshotByTaskId': taskId = base.getNodeParameter('taskId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.emea1b.fenergox.com/creditassessmentquery/api/creditassessment/task/{taskId}/historysnapshot'.replace('{taskId}', taskId);

break;
case 'GetAllCreditAssessmentProviders': 
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.emea1b.fenergox.com/creditassessmentquery/api/providers';

break;
case 'GetCreditAssessmentProvidersById': providerId = base.getNodeParameter('providerId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.emea1b.fenergox.com/creditassessmentquery/api/providers/{providerId}'.replace('{providerId}', providerId);

break;
case 'GetAllCreditAssessmentProvidersConfiguration': 
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.emea1b.fenergox.com/creditassessmentquery/api/providers/configurations';

break;
case 'GetProviderConfigurationById': providerId = base.getNodeParameter('providerId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.emea1b.fenergox.com/creditassessmentquery/api/providers/{providerId}/configuration'.replace('{providerId}', providerId);

break;
case 'GetAllMappingConfiguration': 
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.emea1b.fenergox.com/creditassessmentquery/api/providers/mappingconfigurations';

break;
case 'GetMappingConfigurationByProviderId': providerId = base.getNodeParameter('providerId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.emea1b.fenergox.com/creditassessmentquery/api/providers/{providerId}/mappingconfiguration'.replace('{providerId}', providerId);

break;
case 'GetAllAdapterSchema': 
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.emea1b.fenergox.com/creditassessmentquery/api/providers/adapterSchemas';

break;
case 'GetAdapterSchema': providerId = base.getNodeParameter('providerId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.emea1b.fenergox.com/creditassessmentquery/api/providers/{providerId}/adapterSchema'.replace('{providerId}', providerId);

break;
case 'GetProviderTestResult': providerId = base.getNodeParameter('providerId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.emea1b.fenergox.com/creditassessmentquery/api/providers/{providerId}/test'.replace('{providerId}', providerId);

break;
case 'GetCreditAssessmentProviderConfigurationSummaryByProviderId': providerId = base.getNodeParameter('providerId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.emea1b.fenergox.com/creditassessmentquery/api/providers/{providerId}/configurationSummary'.replace('{providerId}', providerId);

break;
case 'GetCreditAssessmentProviderConfigurationSummaries': 
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.emea1b.fenergox.com/creditassessmentquery/api/providers/configurationSummaries';

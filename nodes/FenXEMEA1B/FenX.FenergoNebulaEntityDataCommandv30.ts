...
requestOptions.uri = 'https://api.emea1b.fenergox.com/entitydatacommand/api/v3/entity/{entityId}/draft/{id}'.replace('{entityId}', entityId).replace('{id}', id);

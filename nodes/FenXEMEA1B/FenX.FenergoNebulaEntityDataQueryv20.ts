...
requestOptions.uri = 'https://api.emea1b.fenergox.com/entitydataquery/api/v2/entity/{id}'.replace('{id}', id);

break;
case 'EntityAdvancedSearch': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.emea1b.fenergox.com/entitydataquery/api/v2/entity/entityadvancedsearch';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'EntityAdvancedSearchFile': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.emea1b.fenergox.com/entitydataquery/api/v2/entity/entityadvancedsearch/file';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'SearchByName': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.emea1b.fenergox.com/entitydataquery/api/v2/entity/searchbyname';
...
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.emea1b.fenergox.com/entitydataquery/api/v2/entity/journey/{journeyId}/task/{taskId}'.replace('{journeyId}', journeyId).replace('{taskId}', taskId);
...
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.emea1b.fenergox.com/entitydataquery/api/v2/entity/{entityId}/journey/{journeyId}/task/{taskId}'.replace('{journeyId}', journeyId).replace('{taskId}', taskId).replace('{entityId}', entityId);
...
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.emea1b.fenergox.com/entitydataquery/api/v2/entity/{entityId}/property/{propertyName}'.replace('{entityId}', entityId).replace('{propertyName}', propertyName);

break;
case 'GetPreSignUrlForFileIdentifiers': entityId = base.getNodeParameter('entityId', 0) as string;
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.emea1b.fenergox.com/entitydataquery/api/v2/entity/{entityId}/pre-sign-urls'.replace('{entityId}', entityId);

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'GetReportPreSignUrl': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.emea1b.fenergox.com/entitydataquery/api/v2/entity/report-pre-sign-url';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'GetEntityDraftsIds': entityId = base.getNodeParameter('entityId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.emea1b.fenergox.com/entitydataquery/api/v2/entity/{entityId}/drafts-ids'.replace('{entityId}', entityId);

break;
case 'GetEntityDraftById': id = base.getNodeParameter('id', 0) as string;
entityId = base.getNodeParameter('entityId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.emea1b.fenergox.com/entitydataquery/api/v2/entity/{entityId}/draft/{id}'.replace('{id}', id).replace('{entityId}', entityId);

break;
case 'GetEntityDraftProposedChanges': entityDraftId = base.getNodeParameter('entityDraftId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.emea1b.fenergox.com/entitydataquery/api/v2/entity/proposedchanges/draft/{entityDraftId}'.replace('{entityDraftId}', entityDraftId);
...
propertyName = base.getNodeParameter('propertyName', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.emea1b.fenergox.com/entitydataquery/api/v2/entity/{entityId}/draft/{entityDraftId}/property/{propertyName}'.replace('{entityId}', entityId).replace('{entityDraftId}', entityDraftId).replace('{propertyName}', propertyName);

break;
case 'GetEntityDraftsLight': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.emea1b.fenergox.com/entitydataquery/api/v2/entity/get-entity-drafts-light';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'SearchEntityDrafts': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.emea1b.fenergox.com/entitydataquery/api/v2/drafts-in-scope/searchentitydrafts';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'GetIndexedEntityProperties': 
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.emea1b.fenergox.com/entitydataquery/api/v2/entity-index-configuration';

break;
case 'GetEntitiesPagedListV2': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.emea1b.fenergox.com/entitydataquery/api/v2/entity/getentitiespagedlist';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'SearchForDuplicatesV2': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.emea1b.fenergox.com/entitydataquery/api/v2/entity/searchforduplicates';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'MultiSearchForDuplicatesV2': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.emea1b.fenergox.com/entitydataquery/api/v2/entity/multisearchforduplicates';

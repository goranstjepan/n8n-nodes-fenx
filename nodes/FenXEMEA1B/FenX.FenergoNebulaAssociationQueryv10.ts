...
requestOptions.uri = 'https://api.emea1b.fenergox.com/associationquery/api/agency/targetlist/journey/{journeyId}'.replace('{journeyId}', journeyId);
...
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.emea1b.fenergox.com/associationquery/api/agency/source/{entityId}/mr/agent'.replace('{entityId}', entityId);
...
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.emea1b.fenergox.com/associationquery/api/agency/snapshot/{journeyId}'.replace('{journeyId}', journeyId);
...
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.emea1b.fenergox.com/associationquery/api/agency/fund/{fundId}/agent/{agentId}/mr'.replace('{fundId}', fundId).replace('{agentId}', agentId);
requestOptions.qs = { journeyId: base.getNodeParameter('journeyId', 0) as string };
break;
case 'GetAllAgencyProductAssociations': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.emea1b.fenergox.com/associationquery/api/agency/product';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'GetVerifiedAssociationHierarchyWithProductByAgentId': agentId = base.getNodeParameter('agentId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.emea1b.fenergox.com/associationquery/api/agency/agent/{agentId}'.replace('{agentId}', agentId);
...
journeyId = base.getNodeParameter('journeyId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.emea1b.fenergox.com/associationquery/api/association/product/{productId}/journey/{journeyId}'.replace('{productId}', productId).replace('{journeyId}', journeyId);
...
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.emea1b.fenergox.com/associationquery/api/association/productToProduct';
...
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.emea1b.fenergox.com/associationquery/api/association/snapshot/{journeyId}/task/{taskId}/root/{entityId}'.replace('{journeyId}', journeyId).replace('{taskId}', taskId).replace('{entityId}', entityId);
...
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.emea1b.fenergox.com/associationquery/api/association/searchForAssociations';

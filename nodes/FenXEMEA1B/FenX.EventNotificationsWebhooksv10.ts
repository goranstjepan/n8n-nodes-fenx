...
requestOptions.uri = 'https://api.emea1b.fenergox.com/webhooks/v1/webhooks';
...
requestOptions.uri = 'https://api.emea1b.fenergox.com/webhooks/v1/webhooks/{webhookId}'.replace('{webhookId}', webhookId);
...
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.emea1b.fenergox.com/webhooks/v1/webhooks/event-notification-types';

break;
case 'TestWebhook': webhookId = base.getNodeParameter('webhookId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.emea1b.fenergox.com/webhooks/v1/webhooks/{webhookId}/test'.replace('{webhookId}', webhookId);

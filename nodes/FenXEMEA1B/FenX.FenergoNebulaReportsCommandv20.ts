...
requestOptions.uri = 'https://api.emea1b.fenergox.com/reportscommand/api/v2/Query';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'UpdateSqlQueryDefinitionV2': Id = base.getNodeParameter('Id', 0) as string;
requestOptions.method = 'PUT';
requestOptions.uri = 'https://api.emea1b.fenergox.com/reportscommand/api/v2/Query/{Id}'.replace('{Id}', Id);
...
case 'CreateReportV2': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.emea1b.fenergox.com/reportscommand/api/v2/Report';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'CreateQueryStatement': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.emea1b.fenergox.com/reportscommand/api/v2/Report/assistant/query';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'CreateChartAsynchronous': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.emea1b.fenergox.com/reportscommand/api/v2/Report/assistant/chart/async';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'CreateRule': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.emea1b.fenergox.com/reportscommand/api/v2/Report/assistant/rules';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'Preview': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.emea1b.fenergox.com/reportscommand/api/v2/Report/Preview';

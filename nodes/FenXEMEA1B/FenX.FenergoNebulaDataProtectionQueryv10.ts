...
requestOptions.uri = 'https://api.emea1b.fenergox.com/dataprotectionquery/api/configuration';

break;
case 'GetAllDataDeletionProcessesByEntityId': entityId = base.getNodeParameter('entityId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.emea1b.fenergox.com/dataprotectionquery/api/datadeletionprocess/{entityId}'.replace('{entityId}', entityId);

break;
case 'GetAllDataDeletionProcessesUpToDate': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.emea1b.fenergox.com/dataprotectionquery/api/datadeletionprocess';
...
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.emea1b.fenergox.com/dataprotectionquery/api/regime';

break;
case 'GetDataProtectionRegime': id = base.getNodeParameter('id', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.emea1b.fenergox.com/dataprotectionquery/api/regime/{id}'.replace('{id}', id);

break;
case 'GetAllEntityCheckConfigurations': 
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.emea1b.fenergox.com/dataprotectionquery/api/entitycheckconfiguration';

break;
case 'GetEntityCheckConfigurationById': configurationId = base.getNodeParameter('configurationId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.emea1b.fenergox.com/dataprotectionquery/api/entitycheckconfiguration/{configurationId}'.replace('{configurationId}', configurationId);
...
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.emea1b.fenergox.com/dataprotectionquery/api/entitycheckconfiguration/{configurationId}/version/{versionNumber}'.replace('{configurationId}', configurationId).replace('{versionNumber}', versionNumber);

break;
case 'GetEntityCheckRequirements': type = base.getNodeParameter('type', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.emea1b.fenergox.com/dataprotectionquery/api/entitycheckrequirements/{type}'.replace('{type}', type);

break;
case 'GetLatestEntityCheckVerification': type = base.getNodeParameter('type', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.emea1b.fenergox.com/dataprotectionquery/api/entitycheckverification/{type}'.replace('{type}', type);
...
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.emea1b.fenergox.com/dataprotectionquery/api/ongoingscreening/{journeyId}/entity/{entityId}'.replace('{journeyId}', journeyId).replace('{entityId}', entityId);

break;
case 'GetAllOrphanEntities': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.emea1b.fenergox.com/dataprotectionquery/api/orphanentity';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'GetOrphanEntityById': id = base.getNodeParameter('id', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.emea1b.fenergox.com/dataprotectionquery/api/orphanentity/{id}'.replace('{id}', id);

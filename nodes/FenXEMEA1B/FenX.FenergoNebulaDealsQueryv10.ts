...
requestOptions.uri = 'https://api.emea1b.fenergox.com/dealsquery/api/deals/drafts/{dealDraftId}'.replace('{dealDraftId}', dealDraftId);

break;
case 'GetDealDraftsByJourneyId': journeyId = base.getNodeParameter('journeyId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.emea1b.fenergox.com/dealsquery/api/deals/drafts/journey/{journeyId}'.replace('{journeyId}', journeyId);

break;
case 'GetAllDeals': 
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.emea1b.fenergox.com/dealsquery/api/deals';

break;
case 'GetDealById': dealId = base.getNodeParameter('dealId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.emea1b.fenergox.com/dealsquery/api/deals/{dealId}'.replace('{dealId}', dealId);
...
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.emea1b.fenergox.com/dealsquery/api/deals/journey/{journeyId}/task/{taskId}'.replace('{journeyId}', journeyId).replace('{taskId}', taskId);

break;
case 'GetVerifiedDealsByEntityId': entityId = base.getNodeParameter('entityId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.emea1b.fenergox.com/dealsquery/api/deals/entity/{entityId}'.replace('{entityId}', entityId);
...
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.emea1b.fenergox.com/dealsquery/api/deals/related-deals/entity/{entityId}/journey/{journeyId}'.replace('{entityId}', entityId).replace('{journeyId}', journeyId);

break;
case 'GetPreSignUrlForFileIdentifiers': dealId = base.getNodeParameter('dealId', 0) as string;
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.emea1b.fenergox.com/dealsquery/api/deals/{dealId}/pre-sign-urls'.replace('{dealId}', dealId);

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'GetAllDealsForEntityJourney': entityId = base.getNodeParameter('entityId', 0) as string;
journeyId = base.getNodeParameter('journeyId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.emea1b.fenergox.com/dealsquery/api/deals/entity/{entityId}/journey/{journeyId}'.replace('{entityId}', entityId).replace('{journeyId}', journeyId);

break;
case 'GetCalculatedPropertyValue': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.emea1b.fenergox.com/dealsquery/api/deals/external-calculations/calculate-property-value';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'GetLetterOfOfferSetByDealId': dealId = base.getNodeParameter('dealId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.emea1b.fenergox.com/dealsquery/api/letter-of-offer/set/deal/{dealId}'.replace('{dealId}', dealId);
...
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.emea1b.fenergox.com/dealsquery/api/letter-of-offer/deal/{dealId}/version/{id}'.replace('{dealId}', dealId).replace('{id}', id);
...
taskId = base.getNodeParameter('taskId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.emea1b.fenergox.com/dealsquery/api/letter-of-offer/set/deal/{dealId}/journey/{journeyId}/task/{taskId}'.replace('{dealId}', dealId).replace('{journeyId}', journeyId).replace('{taskId}', taskId);

break;
case 'GetAllRequirementSets': 
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.emea1b.fenergox.com/dealsquery/api/requirement-set';

break;
case 'GetRequirementSetById': requirementSetId = base.getNodeParameter('requirementSetId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.emea1b.fenergox.com/dealsquery/api/requirement-set/{requirementSetId}'.replace('{requirementSetId}', requirementSetId);

break;
case 'GetActiveRequirementSetVersion': requirementSetId = base.getNodeParameter('requirementSetId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.emea1b.fenergox.com/dealsquery/api/requirement-set/{requirementSetId}/version/active'.replace('{requirementSetId}', requirementSetId);
...
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.emea1b.fenergox.com/dealsquery/api/requirement-set/{requirementSetId}/version/{versionNumber}'.replace('{requirementSetId}', requirementSetId).replace('{versionNumber}', versionNumber);
...
id = base.getNodeParameter('id', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.emea1b.fenergox.com/dealsquery/api/requirement-set/{requirementSetId}/version/{versionNumber}/field/{id}'.replace('{requirementSetId}', requirementSetId).replace('{versionNumber}', versionNumber).replace('{id}', id);

break;
case 'EvaluateRequirements': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.emea1b.fenergox.com/dealsquery/api/requirement-set/evaluate-requirements';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'EvaluateRequirementsReadonly': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.emea1b.fenergox.com/dealsquery/api/requirement-set/evaluate-requirements/read-only';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'GetRequirementsDataSource': 
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.emea1b.fenergox.com/dealsquery/api/requirement-set/requirements-data-source';

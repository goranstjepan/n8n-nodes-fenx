...
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.emea1b.fenergox.com/productpolicyquery/api/product-requirements-in-scope/evaluate-all-requirements';
...
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.emea1b.fenergox.com/productpolicyquery/api/scoping-rule-set';

break;
case 'GetScopingRuleSetById': setId = base.getNodeParameter('setId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.emea1b.fenergox.com/productpolicyquery/api/scoping-rule-set/{setId}'.replace('{setId}', setId);

break;
case 'GetScopingRuleSetVersionById': setId = base.getNodeParameter('setId', 0) as string;
versionNumber = base.getNodeParameter('versionNumber', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.emea1b.fenergox.com/productpolicyquery/api/scoping-rule-set/{setId}/version/{versionNumber}'.replace('{setId}', setId).replace('{versionNumber}', versionNumber);

break;
case 'GetActiveScopingRuleSetVersions': 
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.emea1b.fenergox.com/productpolicyquery/api/scoping-rule-set/activeVersions';

break;
case 'GetActiveScopingRuleSetVersionsByType': type = base.getNodeParameter('type', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.emea1b.fenergox.com/productpolicyquery/api/scoping-rule-set/activeVersions/{type}'.replace('{type}', type);

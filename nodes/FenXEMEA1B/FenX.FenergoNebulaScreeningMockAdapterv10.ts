...
requestOptions.uri = 'https://api.emea1b.fenergox.com/mockadaptercommand/api/screen';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'ResolveMatches': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.emea1b.fenergox.com/mockadaptercommand/api/resolvematches';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'Test': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.emea1b.fenergox.com/mockadaptercommand/api/test';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'OngoingScreening': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.emea1b.fenergox.com/mockadaptercommand/api/ongoingscreening';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'OngoingScreeningUpdate': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.emea1b.fenergox.com/mockadaptercommand/api/ongoingscreeningupdate';

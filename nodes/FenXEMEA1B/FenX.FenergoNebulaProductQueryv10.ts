...
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.emea1b.fenergox.com/productquery/api/product/{entityId}/{journeyId}/{filterOutExcludedSubtype}/filterDraftsByEntityId'.replace('{entityId}', entityId).replace('{journeyId}', journeyId).replace('{filterOutExcludedSubtype}', filterOutExcludedSubtype);
...
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.emea1b.fenergox.com/productquery/api/product/journey/{journeyId}/task/{taskId}/product/{productId}'.replace('{journeyId}', journeyId).replace('{taskId}', taskId).replace('{productId}', productId);

break;
case 'GetPreSignUrlForFileIdentifiers': productId = base.getNodeParameter('productId', 0) as string;
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.emea1b.fenergox.com/productquery/api/product/{productId}/pre-sign-urls'.replace('{productId}', productId);

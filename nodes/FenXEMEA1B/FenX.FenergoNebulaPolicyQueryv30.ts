...
requestOptions.uri = 'https://api.emea1b.fenergox.com/policyquery/api/v3/requirements-in-scope';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'SearchRequirements': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.emea1b.fenergox.com/policyquery/api/v3/requirements-in-scope/search';

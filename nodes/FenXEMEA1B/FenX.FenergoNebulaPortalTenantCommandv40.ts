...
requestOptions.uri = 'https://api.emea1b.fenergox.com/portaltenantcommand/api/dashboard/upsertdashboardconfig';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'UpsertEntityTypeDashboardConfig': 
requestOptions.method = 'PUT';
requestOptions.uri = 'https://api.emea1b.fenergox.com/portaltenantcommand/api/dashboard/entitytypedashboardconfig';
...
requestOptions.method = 'PUT';
requestOptions.uri = 'https://api.emea1b.fenergox.com/portaltenantcommand/api/portal-roles/updateroledetails';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'SetDefaultRole': id = base.getNodeParameter('id', 0) as string;
requestOptions.method = 'PUT';
requestOptions.uri = 'https://api.emea1b.fenergox.com/portaltenantcommand/api/portal-roles/setdefaultrole/{id}'.replace('{id}', id);

break;
case 'CreateRole': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.emea1b.fenergox.com/portaltenantcommand/api/portal-roles/createrole';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'DeletePortalRole': id = base.getNodeParameter('id', 0) as string;
requestOptions.method = 'DELETE';
requestOptions.uri = 'https://api.emea1b.fenergox.com/portaltenantcommand/api/portal-roles/delete/{id}'.replace('{id}', id);

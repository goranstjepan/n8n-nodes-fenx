...
requestOptions.uri = 'https://api.apac1.fenergox.com/externaldatacommand/api/aggregation/saveDataAggregationResults';
...
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.apac1.fenergox.com/externaldatacommand/api/providersconfiguration/flowProvider';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'UpdateFlowProvider': providerId = base.getNodeParameter('providerId', 0) as string;
requestOptions.method = 'PUT';
requestOptions.uri = 'https://api.apac1.fenergox.com/externaldatacommand/api/providersconfiguration/flowProvider/{providerId}'.replace('{providerId}', providerId);

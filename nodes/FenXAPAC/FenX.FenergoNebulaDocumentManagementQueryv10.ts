...
requestOptions.uri = 'https://api.apac1.fenergox.com/documentmanagementquery/api/acceptabledocument/set/{setId}/version/{versionNumber}/acceptableDocument/{id}'.replace('{setId}', setId).replace('{versionNumber}', versionNumber).replace('{id}', id);

break;
case 'GetLatestAcceptableDocuments': 
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.apac1.fenergox.com/documentmanagementquery/api/acceptabledocument';

break;
case 'GetDefaultAcceptableDocumentSet': 
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.apac1.fenergox.com/documentmanagementquery/api/acceptabledocument/set';

break;
case 'GetAcceptableDocumentSetVersion': setId = base.getNodeParameter('setId', 0) as string;
versionNumber = base.getNodeParameter('versionNumber', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.apac1.fenergox.com/documentmanagementquery/api/acceptabledocument/set/{setId}/version/{versionNumber}'.replace('{setId}', setId).replace('{versionNumber}', versionNumber);

break;
case 'GetAllDealDocumentsByDealId': dealId = base.getNodeParameter('dealId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.apac1.fenergox.com/documentmanagementquery/api/deal/documentmanagement/deal/{dealId}'.replace('{dealId}', dealId);

break;
case 'GetPagedDocumentsByDealId': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.apac1.fenergox.com/documentmanagementquery/api/deal/documentmanagement/deal/paged';
...
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.apac1.fenergox.com/documentmanagementquery/api/deal/documentmanagement/deal/{dealId}/journey/{journeyId}'.replace('{dealId}', dealId).replace('{journeyId}', journeyId);

break;
case 'GetDealDocumentModelById': id = base.getNodeParameter('id', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.apac1.fenergox.com/documentmanagementquery/api/deal/documentmanagement/{id}'.replace('{id}', id);

break;
case 'GetAllDealDocumentsByJourneyId': journeyId = base.getNodeParameter('journeyId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.apac1.fenergox.com/documentmanagementquery/api/deal/documentmanagement/journey/{journeyId}'.replace('{journeyId}', journeyId);

break;
case 'GetSignedUrlForDealDocument': id = base.getNodeParameter('id', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.apac1.fenergox.com/documentmanagementquery/api/deal/documentmanagement/signedurl/{id}'.replace('{id}', id);

break;
case 'GetMimeTypesAllowedForDeal': 
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.apac1.fenergox.com/documentmanagementquery/api/deal/documentmanagement/mimeTypesAllowed';

break;
case 'GetAllDealRequirementModelsByJourneyId': journeyId = base.getNodeParameter('journeyId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.apac1.fenergox.com/documentmanagementquery/api/deal/documentrequirement/{journeyId}'.replace('{journeyId}', journeyId);
...
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.apac1.fenergox.com/documentmanagementquery/api/deal/documentrequirement/{journeyId}/{requirementId}'.replace('{journeyId}', journeyId).replace('{requirementId}', requirementId);
...
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.apac1.fenergox.com/documentmanagementquery/api/deal/documentrequirement/journey/{journeyId}/dataKey/{documentDataKey}'.replace('{journeyId}', journeyId).replace('{documentDataKey}', documentDataKey);

break;
case 'GetAllRequirementModelsByDealIdAndJourneyId': dealId = base.getNodeParameter('dealId', 0) as string;
journeyId = base.getNodeParameter('journeyId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.apac1.fenergox.com/documentmanagementquery/api/deal/documentrequirement/deal/{dealId}/journey/{journeyId}'.replace('{dealId}', dealId).replace('{journeyId}', journeyId);

break;
case 'GetAllRequirementModelsByDealId': dealId = base.getNodeParameter('dealId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.apac1.fenergox.com/documentmanagementquery/api/deal/documentrequirement/deal/{dealId}'.replace('{dealId}', dealId);

break;
case 'GetDocumentAssignmentById': id = base.getNodeParameter('id', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.apac1.fenergox.com/documentmanagementquery/api/documentassignment/{id}'.replace('{id}', id);

break;
case 'GetAllDocumentAssignmentByJourneyId': journeyId = base.getNodeParameter('journeyId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.apac1.fenergox.com/documentmanagementquery/api/documentassignment/journey/{journeyId}'.replace('{journeyId}', journeyId);

break;
case 'GetDocumentModelById': id = base.getNodeParameter('id', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.apac1.fenergox.com/documentmanagementquery/api/documentmanagement/{id}'.replace('{id}', id);

break;
case 'GetAllDocumentsByJourneyId': journeyId = base.getNodeParameter('journeyId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.apac1.fenergox.com/documentmanagementquery/api/documentmanagement/journey/{journeyId}'.replace('{journeyId}', journeyId);
...
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.apac1.fenergox.com/documentmanagementquery/api/documentmanagement/entity/{entityId}'.replace('{entityId}', entityId);
requestOptions.qs = { deduplicationEnabled: base.getNodeParameter('deduplicationEnabled', 0) as string };
break;
case 'GetPagedDocumentsByEntityId': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.apac1.fenergox.com/documentmanagementquery/api/documentmanagement/entity/paged';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'GetAllModelsByEntityIdAndJourneyId': entityId = base.getNodeParameter('entityId', 0) as string;
journeyId = base.getNodeParameter('journeyId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.apac1.fenergox.com/documentmanagementquery/api/documentmanagement/entity/{entityId}/journey/{journeyId}'.replace('{entityId}', entityId).replace('{journeyId}', journeyId);
requestOptions.qs = { deduplicationEnabled: base.getNodeParameter('deduplicationEnabled', 0) as string };
break;
case 'GetSignedUrl': id = base.getNodeParameter('id', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.apac1.fenergox.com/documentmanagementquery/api/documentmanagement/signedurl/{id}'.replace('{id}', id);

break;
case 'Getallsupportedmimetypeswhenuploadingafileinthedocumentrequirements.': 
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.apac1.fenergox.com/documentmanagementquery/api/documentmanagement/mimeTypesAllowed';

break;
case 'GetAllRequirementModelsByJourneyId': journeyId = base.getNodeParameter('journeyId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.apac1.fenergox.com/documentmanagementquery/api/documentrequirement/{journeyId}'.replace('{journeyId}', journeyId);

break;
case 'GetDocumentRequirementModelById': journeyId = base.getNodeParameter('journeyId', 0) as string;
requirementId = base.getNodeParameter('requirementId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.apac1.fenergox.com/documentmanagementquery/api/documentrequirement/{journeyId}/{requirementId}'.replace('{journeyId}', journeyId).replace('{requirementId}', requirementId);

break;
case 'GetAllRequirementModelsByEntityIdAndJourneyId': entityId = base.getNodeParameter('entityId', 0) as string;
journeyId = base.getNodeParameter('journeyId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.apac1.fenergox.com/documentmanagementquery/api/documentrequirement/entity/{entityId}/journey/{journeyId}'.replace('{entityId}', entityId).replace('{journeyId}', journeyId);

break;
case 'GetAllRequirementModelsByEntityId': entityId = base.getNodeParameter('entityId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.apac1.fenergox.com/documentmanagementquery/api/documentrequirement/entity/{entityId}'.replace('{entityId}', entityId);

break;
case 'GetDocumentRequirementModelByJourneyIdandDocumentDataKey': journeyId = base.getNodeParameter('journeyId', 0) as string;
documentDataKey = base.getNodeParameter('documentDataKey', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.apac1.fenergox.com/documentmanagementquery/api/documentrequirement/journey/{journeyId}/dataKey/{documentDataKey}'.replace('{journeyId}', journeyId).replace('{documentDataKey}', documentDataKey);
...
id = base.getNodeParameter('id', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.apac1.fenergox.com/documentmanagementquery/api/documentrequirementmetadata/set/{setId}/version/{versionNumber}/documentRequirementMetadata/{id}'.replace('{setId}', setId).replace('{versionNumber}', versionNumber).replace('{id}', id);

break;
case 'GetLatestDocumentRequirementMetadata': 
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.apac1.fenergox.com/documentmanagementquery/api/documentrequirementmetadata';

break;
case 'GetDefaultDocumentRequirementMetadataSet': 
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.apac1.fenergox.com/documentmanagementquery/api/documentrequirementmetadata/set';

break;
case 'GetDocumentRequirementMetadataSetVersion': setId = base.getNodeParameter('setId', 0) as string;
versionNumber = base.getNodeParameter('versionNumber', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.apac1.fenergox.com/documentmanagementquery/api/documentrequirementmetadata/set/{setId}/version/{versionNumber}'.replace('{setId}', setId).replace('{versionNumber}', versionNumber);

break;
case 'GetConfiguration': 
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.apac1.fenergox.com/documentmanagementquery/api/esignatureconfiguration';

break;
case 'GetProviderConfiguration': providerId = base.getNodeParameter('providerId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.apac1.fenergox.com/documentmanagementquery/api/esignatureconfiguration/provider/{providerId}'.replace('{providerId}', providerId);

break;
case 'GetAllESignatureRequirementModelsByJourneyId': journeyId = base.getNodeParameter('journeyId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.apac1.fenergox.com/documentmanagementquery/api/esignaturedocumentrequirement/{journeyId}'.replace('{journeyId}', journeyId);

break;
case 'GetESignatureDocumentRequirementModelById': journeyId = base.getNodeParameter('journeyId', 0) as string;
requirementId = base.getNodeParameter('requirementId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.apac1.fenergox.com/documentmanagementquery/api/esignaturedocumentrequirement/{journeyId}/{requirementId}'.replace('{journeyId}', journeyId).replace('{requirementId}', requirementId);

break;
case 'GetAllESignatureRequirementModelsByEntityIdAndJourneyId': entityId = base.getNodeParameter('entityId', 0) as string;
journeyId = base.getNodeParameter('journeyId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.apac1.fenergox.com/documentmanagementquery/api/esignaturedocumentrequirement/entity/{entityId}/journey/{journeyId}'.replace('{entityId}', entityId).replace('{journeyId}', journeyId);
...
documentDataKey = base.getNodeParameter('documentDataKey', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.apac1.fenergox.com/documentmanagementquery/api/esignaturedocumentrequirement/journey/{journeyId}/dataKey/{documentDataKey}'.replace('{journeyId}', journeyId).replace('{documentDataKey}', documentDataKey);

break;
case 'GetAllProductDocumentsByProductId': productId = base.getNodeParameter('productId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.apac1.fenergox.com/documentmanagementquery/api/product/documentmanagement/product/{productId}'.replace('{productId}', productId);

break;
case 'GetPagedDocumentsByProductId': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.apac1.fenergox.com/documentmanagementquery/api/product/documentmanagement/product/paged';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'GetAllModelsByProductIdAndJourneyId': productId = base.getNodeParameter('productId', 0) as string;
journeyId = base.getNodeParameter('journeyId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.apac1.fenergox.com/documentmanagementquery/api/product/documentmanagement/product/{productId}/journey/{journeyId}'.replace('{productId}', productId).replace('{journeyId}', journeyId);

break;
case 'GetProductDocumentModelById': id = base.getNodeParameter('id', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.apac1.fenergox.com/documentmanagementquery/api/product/documentmanagement/{id}'.replace('{id}', id);

break;
case 'GetAllProductDocumentsByJourneyId': journeyId = base.getNodeParameter('journeyId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.apac1.fenergox.com/documentmanagementquery/api/product/documentmanagement/journey/{journeyId}'.replace('{journeyId}', journeyId);

break;
case 'GetSignedUrlForProductDocument': id = base.getNodeParameter('id', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.apac1.fenergox.com/documentmanagementquery/api/product/documentmanagement/signedurl/{id}'.replace('{id}', id);

break;
case 'GetMimeTypesAllowedForProduct': 
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.apac1.fenergox.com/documentmanagementquery/api/product/documentmanagement/mimeTypesAllowed';

break;
case 'GetAllProductRequirementModelsByJourneyId': journeyId = base.getNodeParameter('journeyId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.apac1.fenergox.com/documentmanagementquery/api/product/documentrequirement/{journeyId}'.replace('{journeyId}', journeyId);

break;
case 'GetProductDocumentRequirementModelById': journeyId = base.getNodeParameter('journeyId', 0) as string;
requirementId = base.getNodeParameter('requirementId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.apac1.fenergox.com/documentmanagementquery/api/product/documentrequirement/{journeyId}/{requirementId}'.replace('{journeyId}', journeyId).replace('{requirementId}', requirementId);
...
documentDataKey = base.getNodeParameter('documentDataKey', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.apac1.fenergox.com/documentmanagementquery/api/product/documentrequirement/journey/{journeyId}/dataKey/{documentDataKey}'.replace('{journeyId}', journeyId).replace('{documentDataKey}', documentDataKey);

break;
case 'GetAllRequirementModelsByProductIdAndJourneyId': productId = base.getNodeParameter('productId', 0) as string;
journeyId = base.getNodeParameter('journeyId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.apac1.fenergox.com/documentmanagementquery/api/product/documentrequirement/product/{productId}/journey/{journeyId}'.replace('{productId}', productId).replace('{journeyId}', journeyId);

break;
case 'GetAllRequirementModelsByProductId': productId = base.getNodeParameter('productId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.apac1.fenergox.com/documentmanagementquery/api/product/documentrequirement/product/{productId}'.replace('{productId}', productId);

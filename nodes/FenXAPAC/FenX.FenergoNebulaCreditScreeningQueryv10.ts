...
requestOptions.uri = 'https://api.apac1.fenergox.com/creditscreeningquery/api/creditscreening/{id}'.replace('{id}', id);

break;
case 'GetCreditScreeningSnapshotById': id = base.getNodeParameter('id', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.apac1.fenergox.com/creditscreeningquery/api/creditscreening/{id}/snapshot'.replace('{id}', id);
...
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.apac1.fenergox.com/creditscreeningquery/api/creditscreening/entity/{entityId}/journey/{journeyId}/task/{taskId}'.replace('{entityId}', entityId).replace('{journeyId}', journeyId).replace('{taskId}', taskId);

break;
case 'GetCreditScreeningByJourneyId': journeyId = base.getNodeParameter('journeyId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.apac1.fenergox.com/creditscreeningquery/api/creditscreening/journey/{journeyId}'.replace('{journeyId}', journeyId);

break;
case 'GetCreditScreeningByJoureyTaskId': journeyId = base.getNodeParameter('journeyId', 0) as string;
taskId = base.getNodeParameter('taskId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.apac1.fenergox.com/creditscreeningquery/api/creditscreening/journey/{journeyId}/task/{taskId}'.replace('{journeyId}', journeyId).replace('{taskId}', taskId);

break;
case 'GetInScopedCreditScreeningByJourneyTaskId': journeyId = base.getNodeParameter('journeyId', 0) as string;
taskId = base.getNodeParameter('taskId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.apac1.fenergox.com/creditscreeningquery/api/creditscreening/journey/{journeyId}/task/{taskId}/screening-in-scope'.replace('{journeyId}', journeyId).replace('{taskId}', taskId);
...
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.apac1.fenergox.com/creditscreeningquery/entity/{entityId}/journey/{journeyId}/history'.replace('{journeyId}', journeyId).replace('{entityId}', entityId);
requestOptions.qs = { size: base.getNodeParameter('size', 0) as string,from: base.getNodeParameter('from', 0) as string };
break;
case 'GetScreeningHistorySnapshotByEntityIdTaskId': taskId = base.getNodeParameter('taskId', 0) as string;
entityId = base.getNodeParameter('entityId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.apac1.fenergox.com/creditscreeningquery/entity/{entityId}/task/{taskId}/historysnapshot'.replace('{taskId}', taskId).replace('{entityId}', entityId);

break;
case 'GetAllCreditScreeningProviders': 
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.apac1.fenergox.com/creditscreeningquery/api/providers';

break;
case 'GetCreditScreeningProvidersById': providerId = base.getNodeParameter('providerId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.apac1.fenergox.com/creditscreeningquery/api/providers/{providerId}'.replace('{providerId}', providerId);

break;
case 'GetAllCreditScreeningProvidersConfiguration': 
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.apac1.fenergox.com/creditscreeningquery/api/providers/configurations';

break;
case 'GetCreditScreeningProviderConfigurationById': providerId = base.getNodeParameter('providerId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.apac1.fenergox.com/creditscreeningquery/api/providers/{providerId}/configuration'.replace('{providerId}', providerId);

break;
case 'GetAllCreditScreeningMappingConfiguration': 
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.apac1.fenergox.com/creditscreeningquery/api/providers/mappingconfigurations';

break;
case 'GetCreditScreeningMappingConfigurationByProviderId': providerId = base.getNodeParameter('providerId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.apac1.fenergox.com/creditscreeningquery/api/providers/{providerId}/mappingconfiguration'.replace('{providerId}', providerId);

break;
case 'GetCreditScreeningAdapterSchemaByProviderId': providerId = base.getNodeParameter('providerId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.apac1.fenergox.com/creditscreeningquery/api/providers/{providerId}/adapterSchema'.replace('{providerId}', providerId);

break;
case 'GetProviderTestResult': providerId = base.getNodeParameter('providerId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.apac1.fenergox.com/creditscreeningquery/api/providers/{providerId}/test'.replace('{providerId}', providerId);

break;
case 'GetCreditScreeningProviderConfigurationSummaryByProviderId': providerId = base.getNodeParameter('providerId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.apac1.fenergox.com/creditscreeningquery/api/providers/{providerId}/configurationsummary'.replace('{providerId}', providerId);

break;
case 'GetCreditScreeningProviderConfigurationSummaries': 
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.apac1.fenergox.com/creditscreeningquery/api/providers/configurationsummary';

break;
case 'GetManualCreditScreeningBySetId': setId = base.getNodeParameter('setId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.apac1.fenergox.com/creditscreeningquery/api/manual/set/{setId}'.replace('{setId}', setId);

break;
case 'GetLatestManualCreditScreeningVersionBySetId': setId = base.getNodeParameter('setId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.apac1.fenergox.com/creditscreeningquery/api/manual/set/{setId}/version/latest'.replace('{setId}', setId);
...
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.apac1.fenergox.com/creditscreeningquery/api/manual/set/{setId}/version/{versionNumber}'.replace('{setId}', setId).replace('{versionNumber}', versionNumber);
...
taskId = base.getNodeParameter('taskId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.apac1.fenergox.com/creditscreeningquery/api/manual/entity/{entityId}/journey/{journeyId}/task/{taskId}'.replace('{entityId}', entityId).replace('{journeyId}', journeyId).replace('{taskId}', taskId);

break;
case 'GetManualScreeningByJourneyTaskId': journeyId = base.getNodeParameter('journeyId', 0) as string;
taskId = base.getNodeParameter('taskId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.apac1.fenergox.com/creditscreeningquery/api/manual/journey/{journeyId}/task/{taskId}'.replace('{journeyId}', journeyId).replace('{taskId}', taskId);

break;
case 'GetInScopedManualScreeningByJourneyTaskId': journeyId = base.getNodeParameter('journeyId', 0) as string;
taskId = base.getNodeParameter('taskId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.apac1.fenergox.com/creditscreeningquery/api/manual/journey/{journeyId}/task/{taskId}/screening-in-scope'.replace('{journeyId}', journeyId).replace('{taskId}', taskId);

break;
case 'GetManualCreditScreeningVersionById': id = base.getNodeParameter('id', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.apac1.fenergox.com/creditscreeningquery/api/manual/version/{id}'.replace('{id}', id);

break;
case 'GetManualCreditScreeningSnapshotBySetIdQuery': setId = base.getNodeParameter('setId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.apac1.fenergox.com/creditscreeningquery/api/manual/set/{setId}/snapshot/latest'.replace('{setId}', setId);

break;
case 'GetManualCreditScreeningSnapshotByJourneyTaskIdQuery': journeyId = base.getNodeParameter('journeyId', 0) as string;
taskId = base.getNodeParameter('taskId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.apac1.fenergox.com/creditscreeningquery/api/manual/journey/{journeyId}/task/{taskId}/snapshot'.replace('{journeyId}', journeyId).replace('{taskId}', taskId);

break;
case 'GetManualCreditScreeningSnapshotBySetIdAndVersionQuery': setId = base.getNodeParameter('setId', 0) as string;
versionNumber = base.getNodeParameter('versionNumber', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.apac1.fenergox.com/creditscreeningquery/api/manual/set/{setId}/version/{versionNumber}/snapshot'.replace('{setId}', setId).replace('{versionNumber}', versionNumber);

...
requestOptions.uri = 'https://api.apac1.fenergox.com/configbaselinequery/api/baseline/latest';

break;
case 'GetByReference': referenceId = base.getNodeParameter('referenceId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.apac1.fenergox.com/configbaselinequery/api/baseline/reference/{referenceId}'.replace('{referenceId}', referenceId);

break;
case 'GetByJourney': journeyId = base.getNodeParameter('journeyId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.apac1.fenergox.com/configbaselinequery/api/baseline/reference/journey/{journeyId}'.replace('{journeyId}', journeyId);

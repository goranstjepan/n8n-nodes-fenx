...
requestOptions.uri = 'https://api.apac1.fenergox.com/identitymanagementquery/api/users';
...
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.apac1.fenergox.com/identitymanagementquery/api/users/{id}'.replace('{id}', id);

...
requestOptions.uri = 'https://api.apac1.fenergox.com/reviewquery/api/data-in-scope/{journeyInstanceId}/products'.replace('{journeyInstanceId}', journeyInstanceId);

break;
case 'GetAllEntityRules': 
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.apac1.fenergox.com/reviewquery/api/entity-rule';

break;
case 'GetEntityRuleById': entityRuleId = base.getNodeParameter('entityRuleId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.apac1.fenergox.com/reviewquery/api/entity-rule/{entityRuleId}'.replace('{entityRuleId}', entityRuleId);
...
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.apac1.fenergox.com/reviewquery/api/entity-rule/{entityRuleId}/version/{versionNumber}'.replace('{entityRuleId}', entityRuleId).replace('{versionNumber}', versionNumber);

break;
case 'GetAllProductRules': 
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.apac1.fenergox.com/reviewquery/api/product-rule';

break;
case 'GetProductRuleById': productRuleId = base.getNodeParameter('productRuleId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.apac1.fenergox.com/reviewquery/api/product-rule/{productRuleId}'.replace('{productRuleId}', productRuleId);

break;
case 'GetProductRuleVersionById': productRuleId = base.getNodeParameter('productRuleId', 0) as string;
versionNumber = base.getNodeParameter('versionNumber', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.apac1.fenergox.com/reviewquery/api/product-rule/{productRuleId}/version/{versionNumber}'.replace('{productRuleId}', productRuleId).replace('{versionNumber}', versionNumber);

break;
case 'GetReviewById': reviewId = base.getNodeParameter('reviewId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.apac1.fenergox.com/reviewquery/api/review/{reviewId}'.replace('{reviewId}', reviewId);

break;
case 'GetPendingReviewsForEntity': entityId = base.getNodeParameter('entityId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.apac1.fenergox.com/reviewquery/api/review/{entityId}/pending-reviews'.replace('{entityId}', entityId);

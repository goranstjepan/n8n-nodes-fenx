...
async function ExecuteFenergoNebulaProductPolicyQueryv10(base: IExecuteFunctions): Promise < INodeExecutionData[][] > {
    ...
    let setId=''; let versionNumber=''; let id=''; let type='';
switch(endpoint){ case 'GetAllProductRequirementSets': 
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.apac1.fenergox.com/productpolicyquery/api/product-requirement-set';
...
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.apac1.fenergox.com/productpolicyquery/api/product-requirement-set/{setId}'.replace('{setId}', setId);
...
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.apac1.fenergox.com/productpolicyquery/api/product-requirement-set/{setId}/version/{versionNumber}'.replace('{setId}', setId).replace('{versionNumber}', versionNumber);
...
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.apac1.fenergox.com/productpolicyquery/api/product-requirement-set/{setId}/version/{versionNumber}/field/{id}'.replace('{setId}', setId).replace('{versionNumber}', versionNumber).replace('{id}', id);

break;
case 'GetJurisdictions': 
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.apac1.fenergox.com/productpolicyquery/api/product-requirement-set/jurisdictions';

break;
case 'GetMergedProductRequirementSetsDataFields': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.apac1.fenergox.com/productpolicyquery/api/product-requirement-set/merged-data-fields';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'EvaluateProductRequirementsInScope': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.apac1.fenergox.com/productpolicyquery/api/product-requirements-in-scope/evaluate';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'EvaluateAllProductRequirements': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.apac1.fenergox.com/productpolicyquery/api/product-requirements-in-scope/evaluate-all-requirements';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'SearchProductRequirements': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.apac1.fenergox.com/productpolicyquery/api/product-requirements-in-scope/search';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'GetProductRequirementsInScope': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.apac1.fenergox.com/productpolicyquery/api/product-requirements-in-scope';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'GetAllScopingRuleSets': 
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.apac1.fenergox.com/productpolicyquery/api/scoping-rule-set';

break;
case 'GetScopingRuleSetById': setId = base.getNodeParameter('setId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.apac1.fenergox.com/productpolicyquery/api/scoping-rule-set/{setId}'.replace('{setId}', setId);

break;
case 'GetScopingRuleSetVersionById': setId = base.getNodeParameter('setId', 0) as string;
versionNumber = base.getNodeParameter('versionNumber', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.apac1.fenergox.com/productpolicyquery/api/scoping-rule-set/{setId}/version/{versionNumber}'.replace('{setId}', setId).replace('{versionNumber}', versionNumber);

break;
case 'GetActiveScopingRuleSetVersions': 
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.apac1.fenergox.com/productpolicyquery/api/scoping-rule-set/activeVersions';

break;
case 'GetActiveScopingRuleSetVersionsByType': type = base.getNodeParameter('type', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.apac1.fenergox.com/productpolicyquery/api/scoping-rule-set/activeVersions/{type}'.replace('{type}', type);

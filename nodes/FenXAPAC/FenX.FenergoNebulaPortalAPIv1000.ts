...
requestOptions.uri = 'https://api.apac1.fenergox.com/portal-bff/api/passwordless/init';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'Returnsmagiclink': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.apac1.fenergox.com/portal-bff/api/passwordless/magiclink';

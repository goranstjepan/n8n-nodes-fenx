...
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.apac1.fenergox.com/documentmanagementcommand/api/documentassignment';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'UpdateDocumentAssignment': id = base.getNodeParameter('id', 0) as string;
requestOptions.method = 'PUT';
requestOptions.uri = 'https://api.apac1.fenergox.com/documentmanagementcommand/api/documentassignment/update/{id}'.replace('{id}', id);
...
requestOptions.method = 'PUT';
requestOptions.uri = 'https://api.apac1.fenergox.com/documentmanagementcommand/api/esignatureconfiguration/provider/{providerId}/refreshIdVProviders'.replace('{providerId}', providerId);

...
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.apac1.fenergox.com/collateralquery/api/collateral/journey/{journeyId}/validateAllocation'.replace('{journeyId}', journeyId);

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'GetRelatedCollateralDataSource': entityId = base.getNodeParameter('entityId', 0) as string;
journeyId = base.getNodeParameter('journeyId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.apac1.fenergox.com/collateralquery/api/collateral/related-collateral/entity/{entityId}/journey/{journeyId}'.replace('{entityId}', entityId).replace('{journeyId}', journeyId);

...
requestOptions.uri = 'https://api.apac1.fenergox.com/portaltenantquery/api/auth0/passwordresetticket/{id}'.replace('{id}', id);

break;
case 'GetDashboardConfigById': id = base.getNodeParameter('id', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.apac1.fenergox.com/portaltenantquery/api/dashboard/dashboardconfig/{id}'.replace('{id}', id);

break;
case 'GetEntityTypeDashboardConfigById': id = base.getNodeParameter('id', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.apac1.fenergox.com/portaltenantquery/api/dashboard/entitytypedashboardconfig/{id}'.replace('{id}', id);

break;
case 'GetDashboardConfigs': 
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.apac1.fenergox.com/portaltenantquery/api/dashboard/dashboardconfigs';

break;
case 'GetEmailProvider': 
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.apac1.fenergox.com/portaltenantquery/api/email/emailprovider';

break;
case 'GetPortalRoleById': id = base.getNodeParameter('id', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.apac1.fenergox.com/portaltenantquery/api/portal-roles/portalrole/{id}'.replace('{id}', id);

break;
case 'GetPortalRoles': 
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.apac1.fenergox.com/portaltenantquery/api/portal-roles/portalroles';

break;
case 'GetPortalUsers': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.apac1.fenergox.com/portaltenantquery/api/portal-users/portalusers';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'GetPortalUserDetails': id = base.getNodeParameter('id', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.apac1.fenergox.com/portaltenantquery/api/portal-users/userdetails/{id}'.replace('{id}', id);

break;
case 'GetPortalUsersLinkedToEntity': entityId = base.getNodeParameter('entityId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.apac1.fenergox.com/portaltenantquery/api/portal-users/portaluserslinked/{entityId}'.replace('{entityId}', entityId);

break;
case 'SearchForLinkLeCandidates': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.apac1.fenergox.com/portaltenantquery/api/portal-users/searchforlinklecandidates';

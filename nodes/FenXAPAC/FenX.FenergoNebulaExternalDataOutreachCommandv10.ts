...
requestOptions.uri = 'https://api.apac1.fenergox.com/externaloutreachcommand/api/association';
...
requestOptions.uri = 'https://api.apac1.fenergox.com/externaloutreachcommand/api/association/{id}/journeyid/{journeyId}'.replace('{id}', id).replace('{journeyId}', journeyId);

break;
case 'UpdateAssociation': id = base.getNodeParameter('id', 0) as string;
requestOptions.method = 'PUT';
requestOptions.uri = 'https://api.apac1.fenergox.com/externaloutreachcommand/api/association/{id}'.replace('{id}', id);

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'UpsertExistingAssociatedEntityComments': journeyId = base.getNodeParameter('journeyId', 0) as string;
requestOptions.method = 'PUT';
requestOptions.uri = 'https://api.apac1.fenergox.com/externaloutreachcommand/api/association/existingassociatedentitycomments/{journeyId}'.replace('{journeyId}', journeyId);

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'UpdateOutreachData': journeyId = base.getNodeParameter('journeyId', 0) as string;
requestOptions.method = 'PUT';
requestOptions.uri = 'https://api.apac1.fenergox.com/externaloutreachcommand/api/data/updateoutreachdata/{journeyId}'.replace('{journeyId}', journeyId);

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'DeleteRelatedOutreachData': id = base.getNodeParameter('id', 0) as string;
journeyId = base.getNodeParameter('journeyId', 0) as string;
requestOptions.method = 'DELETE';
requestOptions.uri = 'https://api.apac1.fenergox.com/externaloutreachcommand/api/related-data/{id}/journey/{journeyId}'.replace('{id}', id).replace('{journeyId}', journeyId);
...
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.apac1.fenergox.com/externaloutreachcommand/api/related-data/{journeyId}'.replace('{journeyId}', journeyId);

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'ClearOutreachRelatedData': journeyId = base.getNodeParameter('journeyId', 0) as string;
requestOptions.method = 'DELETE';
requestOptions.uri = 'https://api.apac1.fenergox.com/externaloutreachcommand/api/related-data/clear/journey/{journeyId}'.replace('{journeyId}', journeyId);

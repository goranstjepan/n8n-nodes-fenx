...
requestOptions.uri = 'https://api.apac1.fenergox.com/journeylogicengine/api/v2/cache/flush';

break;
case 'EvaluateJourneySchemaV2': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.apac1.fenergox.com/journeylogicengine/api/v2/engine/evaluate-journey-schema';

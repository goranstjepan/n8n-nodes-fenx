...
requestOptions.uri = 'https://api.apac1.fenergox.com/covenantsconditionscommand/api/CovenantCondition';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'CreateCovenantConditionVersion': setId = base.getNodeParameter('setId', 0) as string;
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.apac1.fenergox.com/covenantsconditionscommand/api/CovenantCondition/{setId}/version'.replace('{setId}', setId);
...
requestOptions.uri = 'https://api.apac1.fenergox.com/covenantsconditionscommand/api/CovenantCondition/{setId}/version/{id}'.replace('{setId}', setId).replace('{id}', id);

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'UpdateCovenantConditionVersionStatus': setId = base.getNodeParameter('setId', 0) as string;
id = base.getNodeParameter('id', 0) as string;
requestOptions.method = 'PUT';
requestOptions.uri = 'https://api.apac1.fenergox.com/covenantsconditionscommand/api/CovenantCondition/{setId}/version/{id}/status'.replace('{setId}', setId).replace('{id}', id);

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'VerifyCovenantConditionsForJourney': journeyId = base.getNodeParameter('journeyId', 0) as string;
requestOptions.method = 'PUT';
requestOptions.uri = 'https://api.apac1.fenergox.com/covenantsconditionscommand/api/CovenantCondition/journey/{journeyId}/verify'.replace('{journeyId}', journeyId);

break;
case 'SnapshotCovenantConditionConfiguration': setId = base.getNodeParameter('setId', 0) as string;
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.apac1.fenergox.com/covenantsconditionscommand/api/CovenantCondition/set/{setId}/snapshot'.replace('{setId}', setId);

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'UpdateBatch': 
requestOptions.method = 'PUT';
requestOptions.uri = 'https://api.apac1.fenergox.com/covenantsconditionscommand/api/batch/update';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'CompleteBatch': 
requestOptions.method = 'PUT';
requestOptions.uri = 'https://api.apac1.fenergox.com/covenantsconditionscommand/api/batch/complete';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'BatchSnapshot': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.apac1.fenergox.com/covenantsconditionscommand/api/batch/snapshot';

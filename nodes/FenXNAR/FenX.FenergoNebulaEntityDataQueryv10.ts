...
requestOptions.uri = 'https://api.nar1.fenergox.com/entitydataquery/api/entity/getentitieslist';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'GetEntitiesPagedList': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.nar1.fenergox.com/entitydataquery/api/entity/getentitiespagedlist';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'GetEntityById': id = base.getNodeParameter('id', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.nar1.fenergox.com/entitydataquery/api/entity/{id}'.replace('{id}', id);

break;
case 'SearchForDuplicates': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.nar1.fenergox.com/entitydataquery/api/entity/searchforduplicates';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'EntityAdvancedSearch': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.nar1.fenergox.com/entitydataquery/api/entity/entityadvancedsearch';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'EntityAdvancedSearchFile': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.nar1.fenergox.com/entitydataquery/api/entity/entityadvancedsearch/file';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'MultiSearchForDuplicates': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.nar1.fenergox.com/entitydataquery/api/entity/multisearchforduplicates';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'SearchByName': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.nar1.fenergox.com/entitydataquery/api/entity/searchbyname';
...
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.nar1.fenergox.com/entitydataquery/api/entity/journey/{journeyId}/task/{taskId}'.replace('{journeyId}', journeyId).replace('{taskId}', taskId);
...
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.nar1.fenergox.com/entitydataquery/api/entity/{entityId}/journey/{journeyId}/task/{taskId}'.replace('{journeyId}', journeyId).replace('{taskId}', taskId).replace('{entityId}', entityId);
...
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.nar1.fenergox.com/entitydataquery/api/entity/{entityId}/version/{entityVersion}'.replace('{entityId}', entityId).replace('{entityVersion}', entityVersion);
...
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.nar1.fenergox.com/entitydataquery/api/entity/{entityId}/property/{propertyName}'.replace('{entityId}', entityId).replace('{propertyName}', propertyName);

break;
case 'GetPreSignUrlForFileIdentifiers': entityId = base.getNodeParameter('entityId', 0) as string;
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.nar1.fenergox.com/entitydataquery/api/entity/{entityId}/pre-sign-urls'.replace('{entityId}', entityId);

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'GetReportPreSignUrl': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.nar1.fenergox.com/entitydataquery/api/entity/report-pre-sign-url';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'GetEntityDrafts': entityId = base.getNodeParameter('entityId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.nar1.fenergox.com/entitydataquery/api/entity/{entityId}/draft'.replace('{entityId}', entityId);

break;
case 'GetEntityDraftById': id = base.getNodeParameter('id', 0) as string;
entityId = base.getNodeParameter('entityId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.nar1.fenergox.com/entitydataquery/api/entity/{entityId}/draft/{id}'.replace('{id}', id).replace('{entityId}', entityId);

break;
case 'GetEntityDraftProposedChanges': entityDraftId = base.getNodeParameter('entityDraftId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.nar1.fenergox.com/entitydataquery/api/entity/proposedchanges/draft/{entityDraftId}'.replace('{entityDraftId}', entityDraftId);
...
propertyName = base.getNodeParameter('propertyName', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.nar1.fenergox.com/entitydataquery/api/entity/{entityId}/draft/{entityDraftId}/property/{propertyName}'.replace('{entityId}', entityId).replace('{entityDraftId}', entityDraftId).replace('{propertyName}', propertyName);

break;
case 'SearchEntityDrafts': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.nar1.fenergox.com/entitydataquery/api/drafts-in-scope/searchentitydrafts';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'GetIndexedEntityProperties': 
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.nar1.fenergox.com/entitydataquery/api/entity-index-configuration';

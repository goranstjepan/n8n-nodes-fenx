...
requestOptions.uri = 'https://api.nar1.fenergox.com/businessmetricsquery/api/journeycompletedelapsedtimedaily';

break;
case 'GetJourneyCompletedDailyRecordsByDateRange': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.nar1.fenergox.com/businessmetricsquery/api/journeycompletedelapsedtimedaily/getjourneycompletedtimedailyrecordsbydaterange';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'GetJourneySummaryitems': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.nar1.fenergox.com/businessmetricsquery/api/journeysummary';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'GetTaskDailyMetricsByDateRange': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.nar1.fenergox.com/businessmetricsquery/api/taskdailymetrics/gettaskdailymetricsbydaterange';

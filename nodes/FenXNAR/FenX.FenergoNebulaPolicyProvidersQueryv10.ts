...
requestOptions.uri = 'https://api.nar1.fenergox.com/policyprovidersquery/api/external-adapter/suggestions';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'GetMultiFieldSuggestionDetails': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.nar1.fenergox.com/policyprovidersquery/api/external-adapter/suggestion/details';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'GetSuggestions': providerId = base.getNodeParameter('providerId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.nar1.fenergox.com/policyprovidersquery/api/external-adapter/suggestions/{providerId}'.replace('{providerId}', providerId);
...
case 'GetValidation': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.nar1.fenergox.com/policyprovidersquery/api/external-adapter/validation';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'GetDataGroupValidation': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.nar1.fenergox.com/policyprovidersquery/api/external-adapter/validation/datagroup';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'GetCustomTask': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.nar1.fenergox.com/policyprovidersquery/api/external-adapter/validation/customtask';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'GetCalculatedPropertyValue': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.nar1.fenergox.com/policyprovidersquery/api/external-adapter/calculation/property-value';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'GetAllPolicyProviders': 
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.nar1.fenergox.com/policyprovidersquery/api/provider';

break;
case 'GetProviderById': providerId = base.getNodeParameter('providerId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.nar1.fenergox.com/policyprovidersquery/api/provider/{providerId}'.replace('{providerId}', providerId);

break;
case 'GetPolicyProvidersByDataGroupId': dataGroupId = base.getNodeParameter('dataGroupId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.nar1.fenergox.com/policyprovidersquery/api/provider/datagroup/{dataGroupId}'.replace('{dataGroupId}', dataGroupId);

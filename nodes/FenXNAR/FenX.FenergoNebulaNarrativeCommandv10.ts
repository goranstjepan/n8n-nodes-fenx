...
requestOptions.uri = 'https://api.nar1.fenergox.com/narrativecommand/api/business';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'UpdateBusinessNarrative': narrativeId = base.getNodeParameter('narrativeId', 0) as string;
requestOptions.method = 'PUT';
requestOptions.uri = 'https://api.nar1.fenergox.com/narrativecommand/api/business/{narrativeId}'.replace('{narrativeId}', narrativeId);
...
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.nar1.fenergox.com/narrativecommand/api/compliance';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'UpdateComplianceNarrative': narrativeId = base.getNodeParameter('narrativeId', 0) as string;
requestOptions.method = 'PUT';
requestOptions.uri = 'https://api.nar1.fenergox.com/narrativecommand/api/compliance/{narrativeId}'.replace('{narrativeId}', narrativeId);
...
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.nar1.fenergox.com/narrativecommand/api/richtexteditor/{narrativeType}/{entityId}/create-url-to-upload-file'.replace('{entityId}', entityId).replace('{narrativeType}', narrativeType);

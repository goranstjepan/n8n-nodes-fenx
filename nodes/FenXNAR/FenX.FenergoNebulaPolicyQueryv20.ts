...
requestOptions.uri = 'https://api.nar1.fenergox.com/policyquery/api/v2/data-group';
...
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.nar1.fenergox.com/policyquery/api/v2/data-group/latest';

break;
case 'GetDataGroupsLite': 
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.nar1.fenergox.com/policyquery/api/v2/data-group/lite';
requestOptions.qs = { onlyPublishedAndArchived: base.getNodeParameter('onlyPublishedAndArchived', 0) as string };
break;
case 'GetDataGroupById': dataGroupId = base.getNodeParameter('dataGroupId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.nar1.fenergox.com/policyquery/api/v2/data-group/{dataGroupId}'.replace('{dataGroupId}', dataGroupId);
...
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.nar1.fenergox.com/policyquery/api/v2/data-group/{dataGroupId}/version/{versionNumber}'.replace('{dataGroupId}', dataGroupId).replace('{versionNumber}', versionNumber);
...
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.nar1.fenergox.com/policyquery/api/v2/data-group/{dataGroupId}/version/{versionNumber}/field/{id}'.replace('{dataGroupId}', dataGroupId).replace('{versionNumber}', versionNumber).replace('{id}', id);

break;
case 'GetDataGroups': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.nar1.fenergox.com/policyquery/api/v2/data-group/versions';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'GetRequirenmentSetsByIdsLight': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.nar1.fenergox.com/policyquery/api/v2/requirement-set/light';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'GetRequirementSetVersionLightById': setId = base.getNodeParameter('setId', 0) as string;
versionNumber = base.getNodeParameter('versionNumber', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.nar1.fenergox.com/policyquery/api/v2/requirement-set/{setId}/version/{versionNumber}/light'.replace('{setId}', setId).replace('{versionNumber}', versionNumber);
...
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.nar1.fenergox.com/policyquery/api/v2/requirement-set/{versionId}/requirements'.replace('{versionId}', versionId);
...
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.nar1.fenergox.com/policyquery/api/v2/requirement-set/merged-data-fields';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'GetAllRequirementSets': 
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.nar1.fenergox.com/policyquery/api/v2/requirement-set';
...
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.nar1.fenergox.com/policyquery/api/v2/requirement-set/{setId}'.replace('{setId}', setId);

break;
case 'GetRequirementSetVersionById': setId = base.getNodeParameter('setId', 0) as string;
versionNumber = base.getNodeParameter('versionNumber', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.nar1.fenergox.com/policyquery/api/v2/requirement-set/{setId}/version/{versionNumber}'.replace('{setId}', setId).replace('{versionNumber}', versionNumber);
...
id = base.getNodeParameter('id', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.nar1.fenergox.com/policyquery/api/v2/requirement-set/{setId}/version/{versionNumber}/field/{id}'.replace('{setId}', setId).replace('{versionNumber}', versionNumber).replace('{id}', id);

break;
case 'GetJurisdictions': 
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.nar1.fenergox.com/policyquery/api/v2/requirement-set/jurisdictions';

break;
case 'GetRequirementsInScopeV2': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.nar1.fenergox.com/policyquery/api/v2/requirements-in-scope';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'SearchRequirements': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.nar1.fenergox.com/policyquery/api/v2/requirements-in-scope/search';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'EvaluateRequirementsInScope': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.nar1.fenergox.com/policyquery/api/v2/requirements-in-scope/evaluate';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'GetRequirementsByTags': 
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.nar1.fenergox.com/policyquery/api/v2/tag/requirements';
requestOptions.qs = { tags: base.getNodeParameter('tags', 0) as string };
break;
case 'GetTagsByTenant': 
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.nar1.fenergox.com/policyquery/api/v2/tag';

break;
case 'GetTagsByRequirementSetId': setId = base.getNodeParameter('setId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.nar1.fenergox.com/policyquery/api/v2/tag/requirement-set/{setId}'.replace('{setId}', setId);

break;
case 'GetValidationRules': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.nar1.fenergox.com/policyquery/api/v2/validation-rule/validation-rules';

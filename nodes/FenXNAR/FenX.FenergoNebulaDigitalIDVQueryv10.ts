...
requestOptions.uri = 'https://api.nar1.fenergox.com/digitalidvquery/api/configuration';

break;
case 'GetProviderConfiguration': providerId = base.getNodeParameter('providerId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.nar1.fenergox.com/digitalidvquery/api/configuration/provider/{providerId}'.replace('{providerId}', providerId);

break;
case 'GetAssessmentByTask': taskId = base.getNodeParameter('taskId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.nar1.fenergox.com/digitalidvquery/api/dfa/task/{taskId}'.replace('{taskId}', taskId);

break;
case 'GetEntityAssessments': entityId = base.getNodeParameter('entityId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.nar1.fenergox.com/digitalidvquery/api/dfa/entity/{entityId}'.replace('{entityId}', entityId);
...
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.nar1.fenergox.com/digitalidvquery/api/dfa/entity/{entityId}/journey/{journeyId}'.replace('{entityId}', entityId).replace('{journeyId}', journeyId);

break;
case 'GetReasonCodes': 
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.nar1.fenergox.com/digitalidvquery/api/dfa/reason-codes';

break;
case 'GetAllByJourneyId': journeyId = base.getNodeParameter('journeyId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.nar1.fenergox.com/digitalidvquery/api/entity-in-scope/journey/{journeyId}'.replace('{journeyId}', journeyId);
...
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.nar1.fenergox.com/digitalidvquery/api/entity-in-scope/journey/{journeyId}/entity/{entityId}'.replace('{journeyId}', journeyId).replace('{entityId}', entityId);

break;
case 'GetIdvRequirementStatusModelById': id = base.getNodeParameter('id', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.nar1.fenergox.com/digitalidvquery/api/idv-requirement-status/{id}'.replace('{id}', id);

break;
case 'GetIdvRequirementStatusModelByEntityIdAndJourneyId': entityId = base.getNodeParameter('entityId', 0) as string;
journeyId = base.getNodeParameter('journeyId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.nar1.fenergox.com/digitalidvquery/api/idv-requirement-status/entity/{entityId}/journey/{journeyId}'.replace('{entityId}', entityId).replace('{journeyId}', journeyId);

break;
case 'GetVerification': id = base.getNodeParameter('id', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.nar1.fenergox.com/digitalidvquery/api/verification/{id}'.replace('{id}', id);

break;
case 'GetVerificationsByEntity': 
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.nar1.fenergox.com/digitalidvquery/api/verification';
...
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.nar1.fenergox.com/digitalidvquery/api/verification/liveness/{id}'.replace('{id}', id);

break;
case 'GetLivenessValidationsByEntity': entityId = base.getNodeParameter('entityId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.nar1.fenergox.com/digitalidvquery/api/verification/liveness/entity/{entityId}'.replace('{entityId}', entityId);

break;
case 'GetLivenessValidationsByEntityJourney': entityId = base.getNodeParameter('entityId', 0) as string;
journeyId = base.getNodeParameter('journeyId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.nar1.fenergox.com/digitalidvquery/api/verification/liveness/entity/{entityId}/journey/{journeyId}'.replace('{entityId}', entityId).replace('{journeyId}', journeyId);
...
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.nar1.fenergox.com/digitalidvquery/api/verification/task/{taskId}/document/{documentModelId}'.replace('{taskId}', taskId).replace('{documentModelId}', documentModelId);
...
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.nar1.fenergox.com/digitalidvquery/api/verification/{faceImageId}/pre-sign-url'.replace('{faceImageId}', faceImageId);

...
requestOptions.uri = 'https://api.nar1.fenergox.com/screeningcommand/api/v2/batch';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'CompleteBatch': id = base.getNodeParameter('id', 0) as string;
requestOptions.method = 'PUT';
requestOptions.uri = 'https://api.nar1.fenergox.com/screeningcommand/api/v2/batch/{id}/complete'.replace('{id}', id);

break;
case 'UpdateMatches': id = base.getNodeParameter('id', 0) as string;
requestOptions.method = 'PUT';
requestOptions.uri = 'https://api.nar1.fenergox.com/screeningcommand/api/v2/batch/{id}/matches'.replace('{id}', id);
...
requestOptions.method = 'PUT';
requestOptions.uri = 'https://api.nar1.fenergox.com/screeningcommand/api/v2/batch/{id}/entity/{entityId}/updatemateriality'.replace('{id}', id).replace('{entityId}', entityId);

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'CreateConfigurationV2': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.nar1.fenergox.com/screeningcommand/api/v2/configuration';
...
case 'AddProviderV2': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.nar1.fenergox.com/screeningcommand/api/v2/configuration/provider';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'PatchProviderV2': providerId = base.getNodeParameter('providerId', 0) as string;
requestOptions.method = 'PATCH';
requestOptions.uri = 'https://api.nar1.fenergox.com/screeningcommand/api/v2/configuration/provider/{providerId}'.replace('{providerId}', providerId);
...
requestOptions.method = 'PUT';
requestOptions.uri = 'https://api.nar1.fenergox.com/screeningcommand/api/v2/configuration/provider/{providerId}/settings-schema'.replace('{providerId}', providerId);

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'AddConfigurationSetV2': providerId = base.getNodeParameter('providerId', 0) as string;
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.nar1.fenergox.com/screeningcommand/api/v2/configuration/provider/{providerId}/configuration-set'.replace('{providerId}', providerId);
...
requestOptions.method = 'PATCH';
requestOptions.uri = 'https://api.nar1.fenergox.com/screeningcommand/api/v2/configuration/provider/{providerId}/configuration-set/{configurationSetId}'.replace('{providerId}', providerId).replace('{configurationSetId}', configurationSetId);
...
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.nar1.fenergox.com/screeningcommand/api/v2/configuration/provider/{providerId}/test'.replace('{providerId}', providerId);
requestOptions.qs = { configurationSetId: base.getNodeParameter('configurationSetId', 0) as string };
break;
case 'OngoingScreening': 
requestOptions.method = 'PUT';
requestOptions.uri = 'https://api.nar1.fenergox.com/screeningcommand/api/v2/entity/ongoingscreening';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'CreateEntities': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.nar1.fenergox.com/screeningcommand/api/v2/entity';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'UpdateEntity': entityId = base.getNodeParameter('entityId', 0) as string;
requestOptions.method = 'PUT';
requestOptions.uri = 'https://api.nar1.fenergox.com/screeningcommand/api/v2/entity/{entityId}'.replace('{entityId}', entityId);

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'GetEntitiesSubscribedToOgs': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.nar1.fenergox.com/screeningcommand/api/v2/entity/ongoingscreening/generate-report';
requestOptions.qs = { includeSearchCriteria: base.getNodeParameter('includeSearchCriteria', 0) as string };
break;
case 'AddScopedEntities': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.nar1.fenergox.com/screeningcommand/api/v2/scoped-entity';
...
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.nar1.fenergox.com/screeningcommand/api/v2/scoping-rule-set';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'CreateScopingRuleSetVersion': scopingRuleSetId = base.getNodeParameter('scopingRuleSetId', 0) as string;
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.nar1.fenergox.com/screeningcommand/api/v2/scoping-rule-set/{scopingRuleSetId}'.replace('{scopingRuleSetId}', scopingRuleSetId);
...
requestOptions.method = 'PUT';
requestOptions.uri = 'https://api.nar1.fenergox.com/screeningcommand/api/v2/scoping-rule-set/{scopingRuleSetId}/version/{versionNumber}'.replace('{scopingRuleSetId}', scopingRuleSetId).replace('{versionNumber}', versionNumber);
...
versionNumber = base.getNodeParameter('versionNumber', 0) as string;
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.nar1.fenergox.com/screeningcommand/api/v2/scoping-rule-set/{scopingRuleSetId}/version/{versionNumber}/clone'.replace('{scopingRuleSetId}', scopingRuleSetId).replace('{versionNumber}', versionNumber);

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'SubmitScopingRuleSetVersion': scopingRuleSetId = base.getNodeParameter('scopingRuleSetId', 0) as string;
versionNumber = base.getNodeParameter('versionNumber', 0) as string;
requestOptions.method = 'PUT';
requestOptions.uri = 'https://api.nar1.fenergox.com/screeningcommand/api/v2/scoping-rule-set/{scopingRuleSetId}/version/{versionNumber}/submit-for-approval'.replace('{scopingRuleSetId}', scopingRuleSetId).replace('{versionNumber}', versionNumber);

break;
case 'SignScopingRuleSetVersion': scopingRuleSetId = base.getNodeParameter('scopingRuleSetId', 0) as string;
versionNumber = base.getNodeParameter('versionNumber', 0) as string;
requestOptions.method = 'PUT';
requestOptions.uri = 'https://api.nar1.fenergox.com/screeningcommand/api/v2/scoping-rule-set/{scopingRuleSetId}/version/{versionNumber}/sign'.replace('{scopingRuleSetId}', scopingRuleSetId).replace('{versionNumber}', versionNumber);

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'ArchiveScopingRuleSetVersion': scopingRuleSetId = base.getNodeParameter('scopingRuleSetId', 0) as string;
versionNumber = base.getNodeParameter('versionNumber', 0) as string;
requestOptions.method = 'PUT';
requestOptions.uri = 'https://api.nar1.fenergox.com/screeningcommand/api/v2/scoping-rule-set/{scopingRuleSetId}/version/{versionNumber}/archive'.replace('{scopingRuleSetId}', scopingRuleSetId).replace('{versionNumber}', versionNumber);

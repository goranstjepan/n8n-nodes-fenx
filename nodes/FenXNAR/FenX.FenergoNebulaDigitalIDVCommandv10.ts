...
requestOptions.uri = 'https://api.nar1.fenergox.com/digitalidvcommand/api/configuration/provider/{providerId}/status'.replace('{providerId}', providerId);

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'SaveProviderConfiguration': providerId = base.getNodeParameter('providerId', 0) as string;
requestOptions.method = 'PUT';
requestOptions.uri = 'https://api.nar1.fenergox.com/digitalidvcommand/api/configuration/provider/{providerId}/configuration'.replace('{providerId}', providerId);

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'PerformAssessment': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.nar1.fenergox.com/digitalidvcommand/api/dfa';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'CreatesanEntityinScopeforIdv.': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.nar1.fenergox.com/digitalidvcommand/api/entity-in-scope';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'UpdatestheEntityinScopeforIdv.': id = base.getNodeParameter('id', 0) as string;
requestOptions.method = 'PUT';
requestOptions.uri = 'https://api.nar1.fenergox.com/digitalidvcommand/api/entity-in-scope/{id}'.replace('{id}', id);
...
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.nar1.fenergox.com/digitalidvcommand/api/entity-in-scope/evaluate-create-idv-status';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'EvaluateandupdateIDVmodelforanentity': id = base.getNodeParameter('id', 0) as string;
requestOptions.method = 'PUT';
requestOptions.uri = 'https://api.nar1.fenergox.com/digitalidvcommand/api/entity-in-scope/evaluate-update-idv-status/{id}'.replace('{id}', id);

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'CreateIdvRequirementStatusModel': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.nar1.fenergox.com/digitalidvcommand/api/idv-requirement-status';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'CreateSingleIdvRequirementStatusModel': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.nar1.fenergox.com/digitalidvcommand/api/idv-requirement-status/create-single-status';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'UpdateIdvRequirementStatusModel': id = base.getNodeParameter('id', 0) as string;
requestOptions.method = 'PUT';
requestOptions.uri = 'https://api.nar1.fenergox.com/digitalidvcommand/api/idv-requirement-status/{id}'.replace('{id}', id);

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'UpdateSingleIdvRequirementStatusModel': id = base.getNodeParameter('id', 0) as string;
requestOptions.method = 'PUT';
requestOptions.uri = 'https://api.nar1.fenergox.com/digitalidvcommand/api/idv-requirement-status/update-single-status/{id}'.replace('{id}', id);

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'MeasuresthecompletenessofOwnershipandControlIdvrequirements': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.nar1.fenergox.com/digitalidvcommand/api/idv-requirement-status/measure-completeness';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'InitiateVerification': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.nar1.fenergox.com/digitalidvcommand/api/verification';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'FaceLiveness': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.nar1.fenergox.com/digitalidvcommand/api/verification/liveness';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'FaceSimilarity': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.nar1.fenergox.com/digitalidvcommand/api/verification/similarity';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'DocumentValidation': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.nar1.fenergox.com/digitalidvcommand/api/verification/document';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'Createurltouploadfile. ThisendpointisintendedforusewiththeFaceLivenessandSimilarityflows.': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.nar1.fenergox.com/digitalidvcommand/api/verification/create-url-to-upload-file';

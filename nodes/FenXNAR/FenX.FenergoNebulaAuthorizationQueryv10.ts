...
case 'GetUsersNames': 
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.nar1.fenergox.com/authorizationquery/api/reference-data/users';

break;
case 'GetTeamsNames': 
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.nar1.fenergox.com/authorizationquery/api/reference-data/teams';

break;
case 'GetTeamWithUsersById': id = base.getNodeParameter('id', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.nar1.fenergox.com/authorizationquery/api/reference-data/team/{id}'.replace('{id}', id);

break;
case 'GetAccessLayersLight': 
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.nar1.fenergox.com/authorizationquery/api/reference-data/access-layers';

...
requestOptions.method = 'PUT';
requestOptions.uri = 'https://api.nar1.fenergox.com/portaltenantcommand/api/dashboard/entitytypedashboardconfig';
...
case 'CreateRole': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.nar1.fenergox.com/portaltenantcommand/api/portal-roles/createrole';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'DeletePortalRole': id = base.getNodeParameter('id', 0) as string;
requestOptions.method = 'DELETE';
requestOptions.uri = 'https://api.nar1.fenergox.com/portaltenantcommand/api/portal-roles/delete/{id}'.replace('{id}', id);

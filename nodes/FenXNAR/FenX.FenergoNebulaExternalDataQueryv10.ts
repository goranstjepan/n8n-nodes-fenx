...
requestOptions.uri = 'https://api.nar1.fenergox.com/externaldataquery/api/aggregation/{taskId}'.replace('{taskId}', taskId);
...
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.nar1.fenergox.com/externaldataquery/api/providersconfiguration/flowProvider/{providerId}'.replace('{providerId}', providerId);

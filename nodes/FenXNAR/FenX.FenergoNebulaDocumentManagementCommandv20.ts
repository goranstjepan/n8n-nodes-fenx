...
requestOptions.uri = 'https://api.nar1.fenergox.com/documentmanagementcommand/api/v2/acceptabledocument/set';
...
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.nar1.fenergox.com/documentmanagementcommand/api/v2/acceptabledocument/set/{setId}/version/{versionNumber}'.replace('{setId}', setId).replace('{versionNumber}', versionNumber);
...
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.nar1.fenergox.com/documentmanagementcommand/api/v2/acceptabledocument/set/{setId}'.replace('{setId}', setId);
...
versionNumber = base.getNodeParameter('versionNumber', 0) as string;
requestOptions.method = 'PUT';
requestOptions.uri = 'https://api.nar1.fenergox.com/documentmanagementcommand/api/v2/acceptabledocument/set/{setId}/version/{versionNumber}/submit-for-approval'.replace('{setId}', setId).replace('{versionNumber}', versionNumber);

break;
case 'SignAcceptableDocumentSetVersion': setId = base.getNodeParameter('setId', 0) as string;
versionNumber = base.getNodeParameter('versionNumber', 0) as string;
requestOptions.method = 'PUT';
requestOptions.uri = 'https://api.nar1.fenergox.com/documentmanagementcommand/api/v2/acceptabledocument/set/{setId}/version/{versionNumber}/sign'.replace('{setId}', setId).replace('{versionNumber}', versionNumber);

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'ArchiveAcceptableDocumentSetVersion': setId = base.getNodeParameter('setId', 0) as string;
versionNumber = base.getNodeParameter('versionNumber', 0) as string;
requestOptions.method = 'PUT';
requestOptions.uri = 'https://api.nar1.fenergox.com/documentmanagementcommand/api/v2/acceptabledocument/set/{setId}/version/{versionNumber}/archive'.replace('{setId}', setId).replace('{versionNumber}', versionNumber);

break;
case 'CreateAcceptableDocument': setId = base.getNodeParameter('setId', 0) as string;
versionNumber = base.getNodeParameter('versionNumber', 0) as string;
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.nar1.fenergox.com/documentmanagementcommand/api/v2/acceptabledocument/set/{setId}/version/{versionNumber}/acceptableDocument'.replace('{setId}', setId).replace('{versionNumber}', versionNumber);
...
requestOptions.method = 'PUT';
requestOptions.uri = 'https://api.nar1.fenergox.com/documentmanagementcommand/api/v2/acceptabledocument/set/{setId}/version/{versionNumber}/acceptableDocument/{id}'.replace('{setId}', setId).replace('{versionNumber}', versionNumber).replace('{id}', id);
...
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.nar1.fenergox.com/documentmanagementcommand/api/v2/documentassignment';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'UpdateDocumentAssignment': id = base.getNodeParameter('id', 0) as string;
requestOptions.method = 'PUT';
requestOptions.uri = 'https://api.nar1.fenergox.com/documentmanagementcommand/api/v2/documentassignment/update/{id}'.replace('{id}', id);

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'CreateDocumentModel': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.nar1.fenergox.com/documentmanagementcommand/api/v2/documentmanagement';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'product/CreateDocumentModel': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.nar1.fenergox.com/documentmanagementcommand/api/v2/documentmanagement/product/CreateDocumentModel';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'deal/CreateDocumentModel': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.nar1.fenergox.com/documentmanagementcommand/api/v2/documentmanagement/deal/CreateDocumentModel';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'CreateVirtualDocumentModel': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.nar1.fenergox.com/documentmanagementcommand/api/v2/documentmanagement/virtual';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'product/CreateVirtualDocumentModel': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.nar1.fenergox.com/documentmanagementcommand/api/v2/documentmanagement/product/virtual';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'deal/CreateVirtualDocumentModel': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.nar1.fenergox.com/documentmanagementcommand/api/v2/documentmanagement/deal/virtual';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'UpdateFile': 
requestOptions.method = 'PUT';
requestOptions.uri = 'https://api.nar1.fenergox.com/documentmanagementcommand/api/v2/documentmanagement/updateFile';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'UpdateDocumentAccessLayers': id = base.getNodeParameter('id', 0) as string;
requestOptions.method = 'PUT';
requestOptions.uri = 'https://api.nar1.fenergox.com/documentmanagementcommand/api/v2/documentmanagement/{id}/access-layers'.replace('{id}', id);

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'product/UpdateDocumentAccessLayers': id = base.getNodeParameter('id', 0) as string;
requestOptions.method = 'PUT';
requestOptions.uri = 'https://api.nar1.fenergox.com/documentmanagementcommand/api/v2/documentmanagement/product/{id}/access-layers'.replace('{id}', id);

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'deal/UpdateDocumentAccessLayers': id = base.getNodeParameter('id', 0) as string;
requestOptions.method = 'PUT';
requestOptions.uri = 'https://api.nar1.fenergox.com/documentmanagementcommand/api/v2/documentmanagement/deal/{id}/access-layers'.replace('{id}', id);

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'CreateDocumentModelMultipleRequirements': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.nar1.fenergox.com/documentmanagementcommand/api/v2/documentmanagement/CreateDocumentModelMultipleRequirements';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'product/CreateDocumentModelMultipleRequirements': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.nar1.fenergox.com/documentmanagementcommand/api/v2/documentmanagement/product/CreateDocumentModelMultipleRequirements';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'deal/CreateDocumentModelMultipleRequirements': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.nar1.fenergox.com/documentmanagementcommand/api/v2/documentmanagement/deal/CreateDocumentModelMultipleRequirements';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'CreateVirtualDocumentModelMultipleRequirements': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.nar1.fenergox.com/documentmanagementcommand/api/v2/documentmanagement/virtual/multiple-requirements';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'product/CreateVirtualDocumentModelMultipleRequirements': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.nar1.fenergox.com/documentmanagementcommand/api/v2/documentmanagement/product/virtual/multiple-requirements';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'deal/CreateVirtualDocumentModelMultipleRequirements': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.nar1.fenergox.com/documentmanagementcommand/api/v2/documentmanagement/deal/virtual/multiple-requirements';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'CloneDocumentModel': id = base.getNodeParameter('id', 0) as string;
requestOptions.method = 'PUT';
requestOptions.uri = 'https://api.nar1.fenergox.com/documentmanagementcommand/api/v2/documentmanagement/{id}/clone'.replace('{id}', id);

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'product/CloneDocumentModel': id = base.getNodeParameter('id', 0) as string;
requestOptions.method = 'PUT';
requestOptions.uri = 'https://api.nar1.fenergox.com/documentmanagementcommand/api/v2/documentmanagement/product/{id}/clone'.replace('{id}', id);

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'deal/CloneDocumentModel': id = base.getNodeParameter('id', 0) as string;
requestOptions.method = 'PUT';
requestOptions.uri = 'https://api.nar1.fenergox.com/documentmanagementcommand/api/v2/documentmanagement/deal/{id}/clone'.replace('{id}', id);

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'UpdateDocumentModelStatusError': id = base.getNodeParameter('id', 0) as string;
requestOptions.method = 'PUT';
requestOptions.uri = 'https://api.nar1.fenergox.com/documentmanagementcommand/api/v2/documentmanagement/error/{id}'.replace('{id}', id);

break;
case 'product/UpdateDocumentModelStatusError': id = base.getNodeParameter('id', 0) as string;
requestOptions.method = 'PUT';
requestOptions.uri = 'https://api.nar1.fenergox.com/documentmanagementcommand/api/v2/documentmanagement/product/error/{id}'.replace('{id}', id);

break;
case 'deal/UpdateDocumentModelStatusError': id = base.getNodeParameter('id', 0) as string;
requestOptions.method = 'PUT';
requestOptions.uri = 'https://api.nar1.fenergox.com/documentmanagementcommand/api/v2/documentmanagement/deal/error/{id}'.replace('{id}', id);

break;
case 'UpdateDocumentModelCustomError': id = base.getNodeParameter('id', 0) as string;
requestOptions.method = 'PUT';
requestOptions.uri = 'https://api.nar1.fenergox.com/documentmanagementcommand/api/v2/documentmanagement/custom-error/{id}'.replace('{id}', id);

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'product/UpdateDocumentModelCustomError': id = base.getNodeParameter('id', 0) as string;
requestOptions.method = 'PUT';
requestOptions.uri = 'https://api.nar1.fenergox.com/documentmanagementcommand/api/v2/documentmanagement/product/custom-error/{id}'.replace('{id}', id);

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'deal/UpdateDocumentModelCustomError': id = base.getNodeParameter('id', 0) as string;
requestOptions.method = 'PUT';
requestOptions.uri = 'https://api.nar1.fenergox.com/documentmanagementcommand/api/v2/documentmanagement/deal/custom-error/{id}'.replace('{id}', id);

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'UpdateDocument': id = base.getNodeParameter('id', 0) as string;
requestOptions.method = 'PUT';
requestOptions.uri = 'https://api.nar1.fenergox.com/documentmanagementcommand/api/v2/documentmanagement/{id}'.replace('{id}', id);
...
requestOptions.method = 'PUT';
requestOptions.uri = 'https://api.nar1.fenergox.com/documentmanagementcommand/api/v2/documentmanagement/product/{id}'.replace('{id}', id);
...
requestOptions.method = 'PUT';
requestOptions.uri = 'https://api.nar1.fenergox.com/documentmanagementcommand/api/v2/documentmanagement/deal/{id}'.replace('{id}', id);
...
requestOptions.method = 'PUT';
requestOptions.uri = 'https://api.nar1.fenergox.com/documentmanagementcommand/api/v2/documentmanagement/{id}/requirement-ids'.replace('{id}', id);

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'product/UpdateRequirementIds': id = base.getNodeParameter('id', 0) as string;
requestOptions.method = 'PUT';
requestOptions.uri = 'https://api.nar1.fenergox.com/documentmanagementcommand/api/v2/documentmanagement/product/{id}/requirement-ids'.replace('{id}', id);

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'deal/UpdateRequirementIds': id = base.getNodeParameter('id', 0) as string;
requestOptions.method = 'PUT';
requestOptions.uri = 'https://api.nar1.fenergox.com/documentmanagementcommand/api/v2/documentmanagement/deal/{id}/requirement-ids'.replace('{id}', id);

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'UpdateDataKey': id = base.getNodeParameter('id', 0) as string;
requestOptions.method = 'PUT';
requestOptions.uri = 'https://api.nar1.fenergox.com/documentmanagementcommand/api/v2/documentmanagement/{id}/datakey'.replace('{id}', id);

break;
case 'product/UpdateDataKey': id = base.getNodeParameter('id', 0) as string;
requestOptions.method = 'PUT';
requestOptions.uri = 'https://api.nar1.fenergox.com/documentmanagementcommand/api/v2/documentmanagement/product/{id}/datakey'.replace('{id}', id);

break;
case 'deal/UpdateDataKey': id = base.getNodeParameter('id', 0) as string;
requestOptions.method = 'PUT';
requestOptions.uri = 'https://api.nar1.fenergox.com/documentmanagementcommand/api/v2/documentmanagement/deal/{id}/datakey'.replace('{id}', id);

break;
case 'UpdateDocumentUploadedByUserName': id = base.getNodeParameter('id', 0) as string;
requestOptions.method = 'PUT';
requestOptions.uri = 'https://api.nar1.fenergox.com/documentmanagementcommand/api/v2/documentmanagement/{id}/updateDocumentUploadedByUserName'.replace('{id}', id);

break;
case 'UpdateDocumentRequirement': id = base.getNodeParameter('id', 0) as string;
requestOptions.method = 'PUT';
requestOptions.uri = 'https://api.nar1.fenergox.com/documentmanagementcommand/api/v2/documentrequirement/{id}'.replace('{id}', id);

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'product/UpdateDocumentRequirement': id = base.getNodeParameter('id', 0) as string;
requestOptions.method = 'PUT';
requestOptions.uri = 'https://api.nar1.fenergox.com/documentmanagementcommand/api/v2/documentrequirement/product/{id}'.replace('{id}', id);

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'deal/UpdateDocumentRequirement': id = base.getNodeParameter('id', 0) as string;
requestOptions.method = 'PUT';
requestOptions.uri = 'https://api.nar1.fenergox.com/documentmanagementcommand/api/v2/documentrequirement/deal/{id}'.replace('{id}', id);

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'CreateDocumentRequirement': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.nar1.fenergox.com/documentmanagementcommand/api/v2/documentrequirement';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'product/CreateDocumentRequirement': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.nar1.fenergox.com/documentmanagementcommand/api/v2/documentrequirement/product/CreateDocumentRequirement';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'deal/CreateDocumentRequirement': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.nar1.fenergox.com/documentmanagementcommand/api/v2/documentrequirement/deal/CreateDocumentRequirement';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'CreateDocumentRequirementMetadataSet': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.nar1.fenergox.com/documentmanagementcommand/api/v2/documentrequirementmetadata/set';

break;
case 'CreateDocumentRequirementMetadataSetVersionByVersionNumber': setId = base.getNodeParameter('setId', 0) as string;
versionNumber = base.getNodeParameter('versionNumber', 0) as string;
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.nar1.fenergox.com/documentmanagementcommand/api/v2/documentrequirementmetadata/set/{setId}/version/{versionNumber}'.replace('{setId}', setId).replace('{versionNumber}', versionNumber);
...
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.nar1.fenergox.com/documentmanagementcommand/api/v2/documentrequirementmetadata/set/{setId}'.replace('{setId}', setId);
...
versionNumber = base.getNodeParameter('versionNumber', 0) as string;
requestOptions.method = 'PUT';
requestOptions.uri = 'https://api.nar1.fenergox.com/documentmanagementcommand/api/v2/documentrequirementmetadata/set/{setId}/version/{versionNumber}/submit-for-approval'.replace('{setId}', setId).replace('{versionNumber}', versionNumber);

break;
case 'SignDocumentRequirementMetadataSetVersion': setId = base.getNodeParameter('setId', 0) as string;
versionNumber = base.getNodeParameter('versionNumber', 0) as string;
requestOptions.method = 'PUT';
requestOptions.uri = 'https://api.nar1.fenergox.com/documentmanagementcommand/api/v2/documentrequirementmetadata/set/{setId}/version/{versionNumber}/sign'.replace('{setId}', setId).replace('{versionNumber}', versionNumber);

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'ArchiveDocumentRequirementMetadataSetVersion': setId = base.getNodeParameter('setId', 0) as string;
versionNumber = base.getNodeParameter('versionNumber', 0) as string;
requestOptions.method = 'PUT';
requestOptions.uri = 'https://api.nar1.fenergox.com/documentmanagementcommand/api/v2/documentrequirementmetadata/set/{setId}/version/{versionNumber}/archive'.replace('{setId}', setId).replace('{versionNumber}', versionNumber);

break;
case 'CreateDocumentRequirementMetadata': setId = base.getNodeParameter('setId', 0) as string;
versionNumber = base.getNodeParameter('versionNumber', 0) as string;
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.nar1.fenergox.com/documentmanagementcommand/api/v2/documentrequirementmetadata/set/{setId}/version/{versionNumber}/documentRequirementMetadata'.replace('{setId}', setId).replace('{versionNumber}', versionNumber);
...
id = base.getNodeParameter('id', 0) as string;
requestOptions.method = 'PUT';
requestOptions.uri = 'https://api.nar1.fenergox.com/documentmanagementcommand/api/v2/documentrequirementmetadata/set/{setId}/version/{versionNumber}/documentRequirementMetadata/{id}'.replace('{setId}', setId).replace('{versionNumber}', versionNumber).replace('{id}', id);
...
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.nar1.fenergox.com/documentmanagementcommand/api/v2/esignature';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'SaveProviderStatus': providerId = base.getNodeParameter('providerId', 0) as string;
requestOptions.method = 'PUT';
requestOptions.uri = 'https://api.nar1.fenergox.com/documentmanagementcommand/api/v2/esignatureconfiguration/provider/{providerId}/status'.replace('{providerId}', providerId);

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'SaveProviderConfiguration': providerId = base.getNodeParameter('providerId', 0) as string;
requestOptions.method = 'PUT';
requestOptions.uri = 'https://api.nar1.fenergox.com/documentmanagementcommand/api/v2/esignatureconfiguration/provider/{providerId}/configuration'.replace('{providerId}', providerId);

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'RefreshIdVProviders': providerId = base.getNodeParameter('providerId', 0) as string;
requestOptions.method = 'PUT';
requestOptions.uri = 'https://api.nar1.fenergox.com/documentmanagementcommand/api/v2/esignatureconfiguration/provider/{providerId}/refreshIdVProviders'.replace('{providerId}', providerId);

break;
case 'CreateESignatureDocumentRequirement': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.nar1.fenergox.com/documentmanagementcommand/api/v2/esignaturedocumentrequirement';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'UpdateESignatureDocumentRequirement': id = base.getNodeParameter('id', 0) as string;
requestOptions.method = 'PUT';
requestOptions.uri = 'https://api.nar1.fenergox.com/documentmanagementcommand/api/v2/esignaturedocumentrequirement/{id}'.replace('{id}', id);

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'CreateTemporaryDocumentMultipleRequirements': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.nar1.fenergox.com/documentmanagementcommand/api/v2/temporarydocumentmanagement';

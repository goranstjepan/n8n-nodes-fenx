...
requestOptions.uri = 'https://api.nar1.fenergox.com/associationquery/api/agency/target/{entityId}/journey/{journeyId}'.replace('{entityId}', entityId).replace('{journeyId}', journeyId);

break;
case 'GetAgencyAssociationsByTargetIdListAndJourney': journeyId = base.getNodeParameter('journeyId', 0) as string;
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.nar1.fenergox.com/associationquery/api/agency/targetlist/journey/{journeyId}'.replace('{journeyId}', journeyId);

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'GetAgencyAssociationsBySourceAndJourney': entityId = base.getNodeParameter('entityId', 0) as string;
journeyId = base.getNodeParameter('journeyId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.nar1.fenergox.com/associationquery/api/agency/source/{entityId}/journey/{journeyId}'.replace('{entityId}', entityId).replace('{journeyId}', journeyId);

break;
case 'GetAgencyAssociationsInJourney': journeyId = base.getNodeParameter('journeyId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.nar1.fenergox.com/associationquery/api/agency/journey/{journeyId}'.replace('{journeyId}', journeyId);
...
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.nar1.fenergox.com/associationquery/api/agency/agent/{agentId}/source/{sourceId}/verified'.replace('{agentId}', agentId).replace('{sourceId}', sourceId);

break;
case 'GetVerifiedAssociationHierarchyWithProduct': entityId = base.getNodeParameter('entityId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.nar1.fenergox.com/associationquery/api/agency/source/{entityId}/productVerified'.replace('{entityId}', entityId);

break;
case 'GetAgencyMrAssociationsBySourceAndJourney': entityId = base.getNodeParameter('entityId', 0) as string;
journeyId = base.getNodeParameter('journeyId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.nar1.fenergox.com/associationquery/api/agency/source/{entityId}/journey/{journeyId}/mr'.replace('{entityId}', entityId).replace('{journeyId}', journeyId);

break;
case 'GetMrAgentAssociationsBySourceId': entityId = base.getNodeParameter('entityId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.nar1.fenergox.com/associationquery/api/agency/source/{entityId}/mr/agent'.replace('{entityId}', entityId);
...
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.nar1.fenergox.com/associationquery/api/agency/snapshot/{journeyId}'.replace('{journeyId}', journeyId);
...
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.nar1.fenergox.com/associationquery/api/agency/fund/{fundId}/agent/{agentId}/mr'.replace('{fundId}', fundId).replace('{agentId}', agentId);
requestOptions.qs = { journeyId: base.getNodeParameter('journeyId', 0) as string };
break;
case 'GetAllAgencyProductAssociations': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.nar1.fenergox.com/associationquery/api/agency/product';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'GetVerifiedAssociationHierarchyWithProductByAgentId': agentId = base.getNodeParameter('agentId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.nar1.fenergox.com/associationquery/api/agency/agent/{agentId}'.replace('{agentId}', agentId);

break;
case 'GetAssociationById': id = base.getNodeParameter('id', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.nar1.fenergox.com/associationquery/api/association/{id}'.replace('{id}', id);

break;
case 'GetAssociations': EntityId = base.getNodeParameter('EntityId', 0) as string;
JourneyId = base.getNodeParameter('JourneyId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.nar1.fenergox.com/associationquery/api/association/root/{EntityId}/journey/{JourneyId}'.replace('{EntityId}', EntityId).replace('{JourneyId}', JourneyId);

break;
case 'GetVerifiedAssociations': entityId = base.getNodeParameter('entityId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.nar1.fenergox.com/associationquery/api/association/root/{entityId}'.replace('{entityId}', entityId);

break;
case 'GetVerifiedOutboundAssociations': entityId = base.getNodeParameter('entityId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.nar1.fenergox.com/associationquery/api/association/outbound/root/{entityId}'.replace('{entityId}', entityId);

break;
case 'GetAssociationConflicts': EntityId = base.getNodeParameter('EntityId', 0) as string;
JourneyId = base.getNodeParameter('JourneyId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.nar1.fenergox.com/associationquery/api/association/root/{EntityId}/journey/{JourneyId}/conflicts'.replace('{EntityId}', EntityId).replace('{JourneyId}', JourneyId);

break;
case 'GetProductAssociations': EntityId = base.getNodeParameter('EntityId', 0) as string;
JourneyId = base.getNodeParameter('JourneyId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.nar1.fenergox.com/associationquery/api/association/root/{EntityId}/journey/{JourneyId}/product'.replace('{EntityId}', EntityId).replace('{JourneyId}', JourneyId);

break;
case 'GetProductAssociationsByEntityId': entityId = base.getNodeParameter('entityId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.nar1.fenergox.com/associationquery/api/association/root/{entityId}/product'.replace('{entityId}', entityId);

break;
case 'GetAllProductAssociationsByEntityId': entityId = base.getNodeParameter('entityId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.nar1.fenergox.com/associationquery/api/association/root/{entityId}/product/all'.replace('{entityId}', entityId);

break;
case 'GetProductAssociationsByProductId': productId = base.getNodeParameter('productId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.nar1.fenergox.com/associationquery/api/association/product/{productId}'.replace('{productId}', productId);

break;
case 'GetActiveProductAssociationsByProductId': productId = base.getNodeParameter('productId', 0) as string;
journeyId = base.getNodeParameter('journeyId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.nar1.fenergox.com/associationquery/api/association/product/{productId}/journey/{journeyId}'.replace('{productId}', productId).replace('{journeyId}', journeyId);

break;
case 'GetProductToProductAssociationsByProductId': productId = base.getNodeParameter('productId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.nar1.fenergox.com/associationquery/api/association/productToProduct/{productId}'.replace('{productId}', productId);

break;
case 'GetProductToProductAssociationsForProductIdList': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.nar1.fenergox.com/associationquery/api/association/productToProduct';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'GetCollateralAssociations': EntityId = base.getNodeParameter('EntityId', 0) as string;
JourneyId = base.getNodeParameter('JourneyId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.nar1.fenergox.com/associationquery/api/association/root/{EntityId}/journey/{JourneyId}/collateral'.replace('{EntityId}', EntityId).replace('{JourneyId}', JourneyId);

break;
case 'GetCollateralAssociationsByEntityId': entityId = base.getNodeParameter('entityId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.nar1.fenergox.com/associationquery/api/association/root/{entityId}/collateral'.replace('{entityId}', entityId);

break;
case 'GetCollateralAssociationsByCollateralId': collateralId = base.getNodeParameter('collateralId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.nar1.fenergox.com/associationquery/api/association/collateral/{collateralId}'.replace('{collateralId}', collateralId);

break;
case 'GetAssetAssociations': EntityId = base.getNodeParameter('EntityId', 0) as string;
JourneyId = base.getNodeParameter('JourneyId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.nar1.fenergox.com/associationquery/api/association/root/{EntityId}/journey/{JourneyId}/asset'.replace('{EntityId}', EntityId).replace('{JourneyId}', JourneyId);

break;
case 'GetAssetAssociationsByCollateralId': collateralId = base.getNodeParameter('collateralId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.nar1.fenergox.com/associationquery/api/association/root/{collateralId}/asset'.replace('{collateralId}', collateralId);

break;
case 'GetAssetAssociationsByEntityId': entityId = base.getNodeParameter('entityId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.nar1.fenergox.com/associationquery/api/association/root/entity/{entityId}/asset'.replace('{entityId}', entityId);

break;
case 'GetAssetAssociationsByAssetId': assetId = base.getNodeParameter('assetId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.nar1.fenergox.com/associationquery/api/association/asset/{assetId}'.replace('{assetId}', assetId);
...
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.nar1.fenergox.com/associationquery/api/association/snapshot/{journeyId}/task/{taskId}'.replace('{journeyId}', journeyId).replace('{taskId}', taskId);
...
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.nar1.fenergox.com/associationquery/api/association/snapshot/{journeyId}/task/{taskId}/root/{entityId}'.replace('{journeyId}', journeyId).replace('{taskId}', taskId).replace('{entityId}', entityId);

break;
case 'GetTransferAgencyAssociations': entityId = base.getNodeParameter('entityId', 0) as string;
journeyId = base.getNodeParameter('journeyId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.nar1.fenergox.com/associationquery/api/association/root/{entityId}/journey/{journeyId}/transferAgency'.replace('{entityId}', entityId).replace('{journeyId}', journeyId);

break;
case 'GetTransferAgencyAssociationsByFund': fundId = base.getNodeParameter('fundId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.nar1.fenergox.com/associationquery/api/association/root/{fundId}/transferAgencyByFund'.replace('{fundId}', fundId);

break;
case 'GetGroupManagementAssociations': entityId = base.getNodeParameter('entityId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.nar1.fenergox.com/associationquery/api/association/root/{entityId}/groupManagement'.replace('{entityId}', entityId);

break;
case 'GetGroupManagementAssociationsByJourneyId': EntityId = base.getNodeParameter('EntityId', 0) as string;
JourneyId = base.getNodeParameter('JourneyId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.nar1.fenergox.com/associationquery/api/association/root/{EntityId}/journey/{JourneyId}/groupManagement'.replace('{EntityId}', EntityId).replace('{JourneyId}', JourneyId);

break;
case 'GetVerifiedGroupManagementAssociations': entityId = base.getNodeParameter('entityId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.nar1.fenergox.com/associationquery/api/association/root/{entityId}/groupManagement/verified'.replace('{entityId}', entityId);

break;
case 'GetUnverifiedGroupManagementAssociations': EntityId = base.getNodeParameter('EntityId', 0) as string;
JourneyId = base.getNodeParameter('JourneyId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.nar1.fenergox.com/associationquery/api/association/root/{EntityId}/journey/{JourneyId}/groupManagement/unverified'.replace('{EntityId}', EntityId).replace('{JourneyId}', JourneyId);

break;
case 'GetAllGroupsAssociatedBySourceEntityId': sourceEntityId = base.getNodeParameter('sourceEntityId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.nar1.fenergox.com/associationquery/api/association/groupManagementBySourceId/{sourceEntityId}'.replace('{sourceEntityId}', sourceEntityId);
...
journeyId = base.getNodeParameter('journeyId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.nar1.fenergox.com/associationquery/api/association/allGroupManagementBySourceId/{sourceEntityId}/journey/{journeyId}'.replace('{sourceEntityId}', sourceEntityId).replace('{journeyId}', journeyId);

break;
case 'GetProposedChangesByRelatedParty': journeyId = base.getNodeParameter('journeyId', 0) as string;
entityId = base.getNodeParameter('entityId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.nar1.fenergox.com/associationquery/api/association/root/{entityId}/journey/{journeyId}/proposedChanges/relatedParty'.replace('{journeyId}', journeyId).replace('{entityId}', entityId);

break;
case 'GetProposedChangesAssociationsHierarchy': EntityId = base.getNodeParameter('EntityId', 0) as string;
JourneyId = base.getNodeParameter('JourneyId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.nar1.fenergox.com/associationquery/api/association/root/{EntityId}/journey/{JourneyId}/proposedChanges/hierarchy'.replace('{EntityId}', EntityId).replace('{JourneyId}', JourneyId);

break;
case 'GetAllDirectOutboundAssociations': entityId = base.getNodeParameter('entityId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.nar1.fenergox.com/associationquery/api/association/outbound/root/{entityId}/alldirect'.replace('{entityId}', entityId);

break;
case 'SearchForVerifiedAssociations': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.nar1.fenergox.com/associationquery/api/association/searchForVerifiedAssociations';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'SearchForAssociations': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.nar1.fenergox.com/associationquery/api/association/searchForAssociations';
...
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.nar1.fenergox.com/associationquery/api/association/root/{EntityId}/journey/{JourneyId}/maxlevel/{MaxLevel}'.replace('{JourneyId}', JourneyId).replace('{EntityId}', EntityId).replace('{MaxLevel}', MaxLevel);

break;
case 'GetVerifiedAssociationsWithMaxLevel': EntityId = base.getNodeParameter('EntityId', 0) as string;
MaxLevel = base.getNodeParameter('MaxLevel', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.nar1.fenergox.com/associationquery/api/association/root/{EntityId}/maxlevel/{MaxLevel}'.replace('{EntityId}', EntityId).replace('{MaxLevel}', MaxLevel);

break;
case 'GetAllDirectInboundAssociations': entityId = base.getNodeParameter('entityId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.nar1.fenergox.com/associationquery/api/association/inbound/root/{entityId}/alldirect'.replace('{entityId}', entityId);

break;
case 'GetDirectAssociationsByJourney': EntityId = base.getNodeParameter('EntityId', 0) as string;
JourneyId = base.getNodeParameter('JourneyId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.nar1.fenergox.com/associationquery/api/association/root/{EntityId}/journey/{JourneyId}/direct'.replace('{EntityId}', EntityId).replace('{JourneyId}', JourneyId);

break;
case 'GetDealProductAssociations': entityId = base.getNodeParameter('entityId', 0) as string;
journeyId = base.getNodeParameter('journeyId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.nar1.fenergox.com/associationquery/api/deals/root/{entityId}/journey/{journeyId}'.replace('{entityId}', entityId).replace('{journeyId}', journeyId);

break;
case 'GetDealAssociationsByDealId': dealId = base.getNodeParameter('dealId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.nar1.fenergox.com/associationquery/api/deals/deal/{dealId}'.replace('{dealId}', dealId);

break;
case 'GetEntityById': id = base.getNodeParameter('id', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.nar1.fenergox.com/associationquery/api/entity/{id}'.replace('{id}', id);

break;
case 'GetUnwrappingRequirementStatusModelById': id = base.getNodeParameter('id', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.nar1.fenergox.com/associationquery/api/unwrapping-requirement-status/{id}'.replace('{id}', id);

break;
case 'GetUnwrappingRequirementStatusModelByEntityIdAndJourneyId': entityId = base.getNodeParameter('entityId', 0) as string;
journeyId = base.getNodeParameter('journeyId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.nar1.fenergox.com/associationquery/api/unwrapping-requirement-status/entity/{entityId}/journey/{journeyId}'.replace('{entityId}', entityId).replace('{journeyId}', journeyId);

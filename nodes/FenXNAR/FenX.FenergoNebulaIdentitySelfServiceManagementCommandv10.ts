...
requestOptions.uri = 'https://api.nar1.fenergox.com/identitymanagementcommand/api/users';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'DeleteUser': id = base.getNodeParameter('id', 0) as string;
requestOptions.method = 'DELETE';
requestOptions.uri = 'https://api.nar1.fenergox.com/identitymanagementcommand/api/users/{id}'.replace('{id}', id);
...
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.nar1.fenergox.com/identitymanagementcommand/api/users/{id}/send-verification-email'.replace('{id}', id);

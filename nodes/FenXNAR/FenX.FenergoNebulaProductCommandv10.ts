...
requestOptions.uri = 'https://api.nar1.fenergox.com/productcommand/api/product/{productId}/datadeletion/{id}'.replace('{productId}', productId).replace('{id}', id);

break;
case 'CreateProduct': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.nar1.fenergox.com/productcommand/api/product';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'CloneProduct': id = base.getNodeParameter('id', 0) as string;
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.nar1.fenergox.com/productcommand/api/product/{id}/clone'.replace('{id}', id);

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'DeleteProduct': id = base.getNodeParameter('id', 0) as string;
requestOptions.method = 'DELETE';
requestOptions.uri = 'https://api.nar1.fenergox.com/productcommand/api/product/{id}'.replace('{id}', id);
...
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.nar1.fenergox.com/productcommand/api/product/{productId}/draft/journey/{journeyId}'.replace('{productId}', productId).replace('{journeyId}', journeyId);

break;
case 'UpdateProductDraft': productId = base.getNodeParameter('productId', 0) as string;
id = base.getNodeParameter('id', 0) as string;
requestOptions.method = 'PUT';
requestOptions.uri = 'https://api.nar1.fenergox.com/productcommand/api/product/{productId}/draft/{id}'.replace('{productId}', productId).replace('{id}', id);
...
requestOptions.method = 'PUT';
requestOptions.uri = 'https://api.nar1.fenergox.com/productcommand/api/product/{productId}/draft/{id}/verify'.replace('{id}', id).replace('{productId}', productId);

break;
case 'ProductDraftConflicts': productId = base.getNodeParameter('productId', 0) as string;
id = base.getNodeParameter('id', 0) as string;
requestOptions.method = 'PUT';
requestOptions.uri = 'https://api.nar1.fenergox.com/productcommand/api/product/{productId}/draft/{id}/conflicts'.replace('{productId}', productId).replace('{id}', id);

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'ProductDraftsBulkConflicts': 
requestOptions.method = 'PUT';
requestOptions.uri = 'https://api.nar1.fenergox.com/productcommand/api/product/draft/bulkconflicts';

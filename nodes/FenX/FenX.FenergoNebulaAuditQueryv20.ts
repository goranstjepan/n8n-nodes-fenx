...
requestOptions.uri = 'https://api.fenergox.com/auditquery/api/v2/auditevent/resources';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'SearchByTerm': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.fenergox.com/auditquery/api/v2/auditevent/searchterm';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'GetGroupedEntityAuditEvents': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.fenergox.com/auditquery/api/v2/auditevent/groupedEntityEvents';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'GetEntityAuditEventsByFieldName': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.fenergox.com/auditquery/api/v2/auditevent/entityeventdetails';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'GetScreeningAuditEvents': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.fenergox.com/auditquery/api/v2/auditevent/screeningEvents';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'GetJourneyAuditEvents': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.fenergox.com/auditquery/api/v2/auditevent/journeyEvents';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'GetFinancialAnalysisAuditEvents': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.fenergox.com/auditquery/api/v2/auditevent/financialAnalysisEvents';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'GetEntityQuerySideAuditEvents': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.fenergox.com/auditquery/api/v2/auditevent/queryside/entityEvents';

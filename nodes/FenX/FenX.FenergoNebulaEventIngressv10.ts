...
requestOptions.uri = 'https://api.fenergox.com/eventingress/v1/business-process-types';

break;
case 'GetEvent': eventId = base.getNodeParameter('eventId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/eventingress/v1/events/{eventId}'.replace('{eventId}', eventId);

break;
case 'GetEventsByFilter': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.fenergox.com/eventingress/v1/events-by-filter';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'GetEventMessageUrl': eventId = base.getNodeParameter('eventId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/eventingress/v1/events/{eventId}/messageUrl'.replace('{eventId}', eventId);
requestOptions.qs = { type: base.getNodeParameter('type', 0) as string };
break;
case 'SendEvent': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.fenergox.com/eventingress/v1/events';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'GetEventTypes': 
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/eventingress/v1/events/types';

break;
case 'ListEventTypes': 
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/eventingress/v1/event-types';
...
requestOptions.uri = 'https://api.fenergox.com/eventingress/v1/event-types/{eventType}'.replace('{eventType}', eventType);

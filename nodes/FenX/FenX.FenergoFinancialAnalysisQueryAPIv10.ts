...
requestOptions.uri = 'https://api.fenergox.com/financialanalysisquery/api/allocation/set/journey/{journeyId}/task/{taskId}'.replace('{journeyId}', journeyId).replace('{taskId}', taskId);

break;
case 'GetAllocationSetById': setId = base.getNodeParameter('setId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/financialanalysisquery/api/allocation/set/{setId}'.replace('{setId}', setId);

break;
case 'GetAllocationVersionById': id = base.getNodeParameter('id', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/financialanalysisquery/api/allocation/{id}'.replace('{id}', id);
...
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/financialanalysisquery/api/allocation/set/{setId}/version/{versionId}/schema'.replace('{setId}', setId).replace('{versionId}', versionId);

break;
case 'GetAllAllocationConfigurations': 
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/financialanalysisquery/api/configuration/allocation';

break;
case 'GetAllocationConfigurationById': configurationId = base.getNodeParameter('configurationId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/financialanalysisquery/api/configuration/allocation/{configurationId}'.replace('{configurationId}', configurationId);
...
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/financialanalysisquery/api/configuration/allocation/{configurationId}/version/{versionNumber}'.replace('{configurationId}', configurationId).replace('{versionNumber}', versionNumber);

break;
case 'GetAllConfigurations': 
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/financialanalysisquery/api/configuration';

break;
case 'GetConfigurationById': configurationId = base.getNodeParameter('configurationId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/financialanalysisquery/api/configuration/{configurationId}'.replace('{configurationId}', configurationId);

break;
case 'GetConfigurationVersionByVersionNumber': configurationId = base.getNodeParameter('configurationId', 0) as string;
versionNumber = base.getNodeParameter('versionNumber', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/financialanalysisquery/api/configuration/{configurationId}/version/{versionNumber}'.replace('{configurationId}', configurationId).replace('{versionNumber}', versionNumber);

break;
case 'GetFinancialAnalysisSetByEntityId': entityId = base.getNodeParameter('entityId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/financialanalysisquery/api/financialanalysis/set/entity/{entityId}/lite'.replace('{entityId}', entityId);
...
taskId = base.getNodeParameter('taskId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/financialanalysisquery/api/financialanalysis/set/entity/{entityId}/journey/{journeyId}/task/{taskId}'.replace('{entityId}', entityId).replace('{journeyId}', journeyId).replace('{taskId}', taskId);

break;
case 'GetFinancialAnalysisSetsByJourneyTaskId': journeyId = base.getNodeParameter('journeyId', 0) as string;
taskId = base.getNodeParameter('taskId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/financialanalysisquery/api/financialanalysis/set/journey/{journeyId}/task/{taskId}'.replace('{journeyId}', journeyId).replace('{taskId}', taskId);

break;
case 'GetFinancialAnalysisSetById': setId = base.getNodeParameter('setId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/financialanalysisquery/api/financialanalysis/set/{setId}'.replace('{setId}', setId);

break;
case 'GetFinancialAnalysisVersionById': id = base.getNodeParameter('id', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/financialanalysisquery/api/financialanalysis/{id}'.replace('{id}', id);

break;
case 'GetScenario': versionId = base.getNodeParameter('versionId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/financialanalysisquery/api/financialanalysis/version/{versionId}/scenario'.replace('{versionId}', versionId);

break;
case 'GetSummary': versionId = base.getNodeParameter('versionId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/financialanalysisquery/api/financialanalysis/version/{versionId}/summary'.replace('{versionId}', versionId);

break;
case 'GetSchema': setId = base.getNodeParameter('setId', 0) as string;
versionId = base.getNodeParameter('versionId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/financialanalysisquery/api/financialanalysis/set/{setId}/version/{versionId}/schema'.replace('{setId}', setId).replace('{versionId}', versionId);

break;
case 'GetFinancialImportById': id = base.getNodeParameter('id', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/financialanalysisquery/api/import/{id}'.replace('{id}', id);

break;
case 'GetFinanciaImportsByEntityAndJourneyId': entityId = base.getNodeParameter('entityId', 0) as string;
journeyId = base.getNodeParameter('journeyId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/financialanalysisquery/api/import/entity/{entityId}/journey/{journeyId}'.replace('{entityId}', entityId).replace('{journeyId}', journeyId);

break;
case 'GetAllImportProviders': 
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/financialanalysisquery/api/import/provider';

break;
case 'GetImportProviderById': providerId = base.getNodeParameter('providerId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/financialanalysisquery/api/import/provider/{providerId}'.replace('{providerId}', providerId);

break;
case 'GetAllImportMappings': 
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/financialanalysisquery/api/import/provider/mapping';

break;
case 'GetImportMappingByProviderId': providerId = base.getNodeParameter('providerId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/financialanalysisquery/api/import/provider/{providerId}/mapping'.replace('{providerId}', providerId);

break;
case 'GetAdapterSchemaByProviderId': providerId = base.getNodeParameter('providerId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/financialanalysisquery/api/import/provider/{providerId}/adapterSchema'.replace('{providerId}', providerId);

break;
case 'GetImportProviderConfigurationSummaryByProviderId': providerId = base.getNodeParameter('providerId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/financialanalysisquery/api/import/provider/{providerId}/configurationSummary'.replace('{providerId}', providerId);

break;
case 'GetImportProviderConfigurationSummaries': 
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/financialanalysisquery/api/import/provider/configurationSummaries';

break;
case 'GetFinancialAnalysisReportBySetIdAndVersionId': setId = base.getNodeParameter('setId', 0) as string;
versionId = base.getNodeParameter('versionId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/financialanalysisquery/api/report/set/{setId}/version/{versionId}'.replace('{setId}', setId).replace('{versionId}', versionId);

...
requestOptions.uri = 'https://api.fenergox.com/narrativequery/api/business/search';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'GetBusinessNarrativeById': narrativeId = base.getNodeParameter('narrativeId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/narrativequery/api/business/{narrativeId}'.replace('{narrativeId}', narrativeId);

break;
case 'GetPreSignBusinessUrlForFileIdentifiers': entityId = base.getNodeParameter('entityId', 0) as string;
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.fenergox.com/narrativequery/api/business/{entityId}/pre-sign-urls'.replace('{entityId}', entityId);

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'SearchComplianceNarratives': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.fenergox.com/narrativequery/api/compliance/search';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'GetComplianceNarrativeById': narrativeId = base.getNodeParameter('narrativeId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/narrativequery/api/compliance/{narrativeId}'.replace('{narrativeId}', narrativeId);

break;
case 'GetPreSignComplianceUrlForFileIdentifiers': entityId = base.getNodeParameter('entityId', 0) as string;
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.fenergox.com/narrativequery/api/compliance/{entityId}/pre-sign-urls'.replace('{entityId}', entityId);

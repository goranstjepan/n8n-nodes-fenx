...
requestOptions.uri = 'https://api.fenergox.com/portaltenantcommand/api/dashboard/upsertdashboardconfig';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'UpsertEntityTypeDashboardConfig': 
requestOptions.method = 'PUT';
requestOptions.uri = 'https://api.fenergox.com/portaltenantcommand/api/dashboard/entitytypedashboardconfig';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'SendEmail': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.fenergox.com/portaltenantcommand/api/email/sendemail';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'UpdateRoleDetails': 
requestOptions.method = 'PUT';
requestOptions.uri = 'https://api.fenergox.com/portaltenantcommand/api/portal-roles/updateroledetails';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'SetDefaultRole': id = base.getNodeParameter('id', 0) as string;
requestOptions.method = 'PUT';
requestOptions.uri = 'https://api.fenergox.com/portaltenantcommand/api/portal-roles/setdefaultrole/{id}'.replace('{id}', id);

break;
case 'CreateRole': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.fenergox.com/portaltenantcommand/api/portal-roles/createrole';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'DeletePortalRole': id = base.getNodeParameter('id', 0) as string;
requestOptions.method = 'DELETE';
requestOptions.uri = 'https://api.fenergox.com/portaltenantcommand/api/portal-roles/delete/{id}'.replace('{id}', id);

break;
case 'AddUserEntityLinks': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.fenergox.com/portaltenantcommand/api/portal-users/adduserentitylinks';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'UpdateUserStatus': 
requestOptions.method = 'PUT';
requestOptions.uri = 'https://api.fenergox.com/portaltenantcommand/api/portal-users/updateuserstatus';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'DeleteUserEntityLink': id = base.getNodeParameter('id', 0) as string;
requestOptions.method = 'DELETE';
requestOptions.uri = 'https://api.fenergox.com/portaltenantcommand/api/portal-users/deleteuserentitylink/{id}'.replace('{id}', id);

break;
case 'CreateUser': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.fenergox.com/portaltenantcommand/api/portal-users/createuser';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'RemovePortalUser': id = base.getNodeParameter('id', 0) as string;
requestOptions.method = 'DELETE';
requestOptions.uri = 'https://api.fenergox.com/portaltenantcommand/api/portal-users/remove/{id}'.replace('{id}', id);

break;
case 'UpdateUserDetails': 
requestOptions.method = 'PUT';
requestOptions.uri = 'https://api.fenergox.com/portaltenantcommand/api/portal-users/updateuserdetails';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'CreateUserWithEntitiesLinks': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.fenergox.com/portaltenantcommand/api/portal-users/createuserwithentitieslinks';

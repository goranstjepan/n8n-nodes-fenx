...
requestOptions.uri = 'https://api.fenergox.com/policylogicengine/api/v2/cache/flush';
...
requestOptions.uri = 'https://api.fenergox.com/policylogicengine/api/v2/engine/evaluate-requirements';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'EvaluateRequirementSets': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.fenergox.com/policylogicengine/api/v2/engine/evaluate-requirement-sets';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'EvaluateDataGroupFields': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.fenergox.com/policylogicengine/api/v2/engine/evaluate-data-group-fields';

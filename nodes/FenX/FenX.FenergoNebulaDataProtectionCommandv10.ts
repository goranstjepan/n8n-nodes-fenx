...
requestOptions.uri = 'https://api.fenergox.com/dataprotectioncommand/api/configuration';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'UpdateConfiguration': id = base.getNodeParameter('id', 0) as string;
requestOptions.method = 'PUT';
requestOptions.uri = 'https://api.fenergox.com/dataprotectioncommand/api/configuration/{id}'.replace('{id}', id);

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'DeleteEntityData': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.fenergox.com/dataprotectioncommand/api/datadeletion/deleteEntityData';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'MarkForDeletion': entityId = base.getNodeParameter('entityId', 0) as string;
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.fenergox.com/dataprotectioncommand/api/datadeletion/markForDeletion/{entityId}'.replace('{entityId}', entityId);

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'CreateDataDeletionProcess': entityId = base.getNodeParameter('entityId', 0) as string;
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.fenergox.com/dataprotectioncommand/api/datadeletionprocess/{entityId}'.replace('{entityId}', entityId);
...
requestOptions.method = 'PUT';
requestOptions.uri = 'https://api.fenergox.com/dataprotectioncommand/api/datadeletionprocess/{entityId}/{id}'.replace('{entityId}', entityId).replace('{id}', id);
...
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.fenergox.com/dataprotectioncommand/api/regime';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'UpdateDataProtectionRegime': id = base.getNodeParameter('id', 0) as string;
requestOptions.method = 'PUT';
requestOptions.uri = 'https://api.fenergox.com/dataprotectioncommand/api/regime/{id}'.replace('{id}', id);
...
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.fenergox.com/dataprotectioncommand/api/dataretentioncheck/triggerdataretentioncheck';

break;
case 'CreateEntityCheckConfiguration': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.fenergox.com/dataprotectioncommand/api/entitycheckconfiguration';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'CreateEntityCheckConfigurationVersion': configurationId = base.getNodeParameter('configurationId', 0) as string;
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.fenergox.com/dataprotectioncommand/api/entitycheckconfiguration/{configurationId}'.replace('{configurationId}', configurationId);
...
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.fenergox.com/dataprotectioncommand/api/entitycheckconfiguration/{configurationId}/version/{versionNumber}/draft'.replace('{configurationId}', configurationId).replace('{versionNumber}', versionNumber);

break;
case 'UpdateEntityCheckConfigurationVersion': configurationId = base.getNodeParameter('configurationId', 0) as string;
versionNumber = base.getNodeParameter('versionNumber', 0) as string;
requestOptions.method = 'PUT';
requestOptions.uri = 'https://api.fenergox.com/dataprotectioncommand/api/entitycheckconfiguration/{configurationId}/version/{versionNumber}'.replace('{configurationId}', configurationId).replace('{versionNumber}', versionNumber);
...
versionNumber = base.getNodeParameter('versionNumber', 0) as string;
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.fenergox.com/dataprotectioncommand/api/entitycheckconfiguration/{configurationId}/version/{versionNumber}/clone'.replace('{configurationId}', configurationId).replace('{versionNumber}', versionNumber);

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'SubmitEntityCheckConfigurationVersion': configurationId = base.getNodeParameter('configurationId', 0) as string;
versionNumber = base.getNodeParameter('versionNumber', 0) as string;
requestOptions.method = 'PUT';
requestOptions.uri = 'https://api.fenergox.com/dataprotectioncommand/api/entitycheckconfiguration/{configurationId}/version/{versionNumber}/submit-for-approval'.replace('{configurationId}', configurationId).replace('{versionNumber}', versionNumber);

break;
case 'SignEntityCheckConfigurationVersion': configurationId = base.getNodeParameter('configurationId', 0) as string;
versionNumber = base.getNodeParameter('versionNumber', 0) as string;
requestOptions.method = 'PUT';
requestOptions.uri = 'https://api.fenergox.com/dataprotectioncommand/api/entitycheckconfiguration/{configurationId}/version/{versionNumber}/sign'.replace('{configurationId}', configurationId).replace('{versionNumber}', versionNumber);

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'ArchiveEntityCheckConfigurationVersion': configurationId = base.getNodeParameter('configurationId', 0) as string;
versionNumber = base.getNodeParameter('versionNumber', 0) as string;
requestOptions.method = 'PUT';
requestOptions.uri = 'https://api.fenergox.com/dataprotectioncommand/api/entitycheckconfiguration/{configurationId}/version/{versionNumber}/archive'.replace('{configurationId}', configurationId).replace('{versionNumber}', versionNumber);

break;
case 'CreateUnsubscribeBatch': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.fenergox.com/dataprotectioncommand/api/ongoingscreening';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'UpdateUnsubscribeBatchEntities': id = base.getNodeParameter('id', 0) as string;
requestOptions.method = 'PUT';
requestOptions.uri = 'https://api.fenergox.com/dataprotectioncommand/api/ongoingscreening/{id}'.replace('{id}', id);

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'CreateOrphanEntity': entityId = base.getNodeParameter('entityId', 0) as string;
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.fenergox.com/dataprotectioncommand/api/orphanentity/{entityId}'.replace('{entityId}', entityId);
...
requestOptions.method = 'PUT';
requestOptions.uri = 'https://api.fenergox.com/dataprotectioncommand/api/orphanentity/{id}/update'.replace('{id}', id);

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'VerifyOrphanEntity': entityId = base.getNodeParameter('entityId', 0) as string;
requestOptions.method = 'PUT';
requestOptions.uri = 'https://api.fenergox.com/dataprotectioncommand/api/orphanentity/{entityId}/verify'.replace('{entityId}', entityId);

break;
case 'VerifyAllOrphanEnties': 
requestOptions.method = 'PUT';
requestOptions.uri = 'https://api.fenergox.com/dataprotectioncommand/api/orphanentity/verifyAll';

break;
case 'TriggerOrphanEntityCheck': configurationId = base.getNodeParameter('configurationId', 0) as string;
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.fenergox.com/dataprotectioncommand/api/orphanentityprocess/{configurationId}/orphanentitycheck'.replace('{configurationId}', configurationId);

break;
case 'TriggerDeleteExpiredOrphanEntitites': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.fenergox.com/dataprotectioncommand/api/orphanentityprocess/deleteexpiredorphan';

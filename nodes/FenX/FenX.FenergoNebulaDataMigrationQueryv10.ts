...
requestOptions.uri = 'https://api.fenergox.com/datamigrationquery/api/migration/{id}'.replace('{id}', id);

break;
case 'GetArtifacts': id = base.getNodeParameter('id', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/datamigrationquery/api/migration/{id}/get-artifacts'.replace('{id}', id);

break;
case 'GetArtifactContent': id = base.getNodeParameter('id', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/datamigrationquery/api/migration/{id}/get-artifact-content'.replace('{id}', id);
...
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/datamigrationquery/api/migration/{id}/get-error-file'.replace('{id}', id);

break;
case 'GetMigratedRecords': id = base.getNodeParameter('id', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/datamigrationquery/api/migration/{id}/get-migrated-records-file'.replace('{id}', id);

break;
case 'GetErrorFileSignedUrl': id = base.getNodeParameter('id', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/datamigrationquery/api/migration/{id}/get-error-file-signed-url'.replace('{id}', id);

break;
case 'GetRecordReferenceIngestionExecution': id = base.getNodeParameter('id', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/datamigrationquery/api/record-reference-ingestion/{id}/execution'.replace('{id}', id);

break;
case 'GetJurisdictionEvaluationExecution': id = base.getNodeParameter('id', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/datamigrationquery/api/jurisdiction-evaluation/{id}/execution'.replace('{id}', id);

break;
case 'GetRecordReferenceIngestionExecutionErrorDetailFile': id = base.getNodeParameter('id', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/datamigrationquery/api/record-reference-ingestion/{id}/execution-error-detail-file'.replace('{id}', id);

break;
case 'GetAccessLayerPropagationExecution': id = base.getNodeParameter('id', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/datamigrationquery/api/access-layer-propagation/{id}/execution'.replace('{id}', id);

break;
case 'GetstheAccessLayerpropagationexecutionprogressinformation.': processId = base.getNodeParameter('processId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/datamigrationquery/api/access-layer-propagation-progress/{processId}'.replace('{processId}', processId);

break;
case 'GetMigrationsFile': 
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/datamigrationquery/api/migrations/file';

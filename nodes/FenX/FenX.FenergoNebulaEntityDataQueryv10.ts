...
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/entitydataquery/api/entity/{entityId}/journey/{journeyId}/task/{taskId}'.replace('{journeyId}', journeyId).replace('{taskId}', taskId).replace('{entityId}', entityId);
...
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.fenergox.com/entitydataquery/api/entity/report-pre-sign-url';

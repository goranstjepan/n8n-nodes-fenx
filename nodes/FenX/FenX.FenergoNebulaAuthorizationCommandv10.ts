...
requestOptions.uri = 'https://api.fenergox.com/authorizationcommand/api/access-layer';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'UpdateAccessLayer': id = base.getNodeParameter('id', 0) as string;
requestOptions.method = 'PUT';
requestOptions.uri = 'https://api.fenergox.com/authorizationcommand/api/access-layer/{id}'.replace('{id}', id);
...
requestOptions.method = 'PUT';
requestOptions.uri = 'https://api.fenergox.com/authorizationcommand/api/access-layer/{id}/user/{userId}'.replace('{id}', id).replace('{userId}', userId);
...
requestOptions.method = 'PUT';
requestOptions.uri = 'https://api.fenergox.com/authorizationcommand/api/access-layer/users/{userId}/batch'.replace('{userId}', userId);

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'UpdateAccessLayersConfiguration': 
requestOptions.method = 'PUT';
requestOptions.uri = 'https://api.fenergox.com/authorizationcommand/api/access-layer/configuration';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'CreateDynamicConfiguration': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.fenergox.com/authorizationcommand/api/dynamic-configuration';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'CloneDynamicConfiguration': id = base.getNodeParameter('id', 0) as string;
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.fenergox.com/authorizationcommand/api/dynamic-configuration/{id}/clone'.replace('{id}', id);

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'UpdateDynamicConfiguration': id = base.getNodeParameter('id', 0) as string;
requestOptions.method = 'PUT';
requestOptions.uri = 'https://api.fenergox.com/authorizationcommand/api/dynamic-configuration/{id}'.replace('{id}', id);
...
requestOptions.method = 'PUT';
requestOptions.uri = 'https://api.fenergox.com/authorizationcommand/api/related-party-access-layers-inheritance-configuration/update';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'CreateTeam': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.fenergox.com/authorizationcommand/api/team';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'UpdateTeam': id = base.getNodeParameter('id', 0) as string;
requestOptions.method = 'PUT';
requestOptions.uri = 'https://api.fenergox.com/authorizationcommand/api/team/{id}'.replace('{id}', id);
...
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.fenergox.com/authorizationcommand/api/team/{id}/clone'.replace('{id}', id);

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'AddUserToTeam': id = base.getNodeParameter('id', 0) as string;
userId = base.getNodeParameter('userId', 0) as string;
requestOptions.method = 'PUT';
requestOptions.uri = 'https://api.fenergox.com/authorizationcommand/api/team/{id}/user/{userId}'.replace('{id}', id).replace('{userId}', userId);
...
requestOptions.method = 'PUT';
requestOptions.uri = 'https://api.fenergox.com/authorizationcommand/api/team/users/{userId}/batch'.replace('{userId}', userId);

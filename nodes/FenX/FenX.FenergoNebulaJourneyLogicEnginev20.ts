...
requestOptions.uri = 'https://api.fenergox.com/journeylogicengine/api/v2/cache/flush';

break;
case 'EvaluateJourneySchemaV2': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.fenergox.com/journeylogicengine/api/v2/engine/evaluate-journey-schema';

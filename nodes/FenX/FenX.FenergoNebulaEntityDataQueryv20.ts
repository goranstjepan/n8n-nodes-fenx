...
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.fenergox.com/entitydataquery/api/v2/entity/report-pre-sign-url';
...
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.fenergox.com/entitydataquery/api/v2/entity/get-entity-drafts-light';

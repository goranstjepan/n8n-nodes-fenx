...
requestOptions.uri = 'https://api.fenergox.com/businessmetricscommand/api/journeysummary';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'TriggerthecreationofaJourneySummaryforallcurrentlyscheduledjourneys': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.fenergox.com/businessmetricscommand/api/journeysummary/triggerscheduledsummaries';

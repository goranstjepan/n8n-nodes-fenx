...
requestOptions.uri = 'https://api.fenergox.com/externaldataquery/api/aggregation/{taskId}'.replace('{taskId}', taskId);

break;
case 'GetConfigurationV2': 
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/externaldataquery/api/providersconfiguration';

break;
case 'GetProviderConfigurationV2': providerId = base.getNodeParameter('providerId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/externaldataquery/api/providersconfiguration/provider/{providerId}'.replace('{providerId}', providerId);

break;
case 'GetCustomProviderConfigurationV2': providerId = base.getNodeParameter('providerId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/externaldataquery/api/providersconfiguration/customProvider/{providerId}'.replace('{providerId}', providerId);

break;
case 'GetFlowProvider': providerId = base.getNodeParameter('providerId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/externaldataquery/api/providersconfiguration/flowProvider/{providerId}'.replace('{providerId}', providerId);

break;
case 'GetAdapterSchema': providerId = base.getNodeParameter('providerId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/externaldataquery/api/providersconfiguration/adapterschema/{providerId}'.replace('{providerId}', providerId);
...
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/externaldataquery/api/document/signedurl/{fileName}'.replace('{fileName}', fileName);

break;
case 'GetImportedDataById': id = base.getNodeParameter('id', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/externaldataquery/api/import/{id}'.replace('{id}', id);
...
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/externaldataquery/api/import/journey/{journeyId}/externalId/{externalId}'.replace('{journeyId}', journeyId).replace('{externalId}', externalId);

break;
case 'GetImportIdentifierOfLastSavedImportByJourneyId': journeyId = base.getNodeParameter('journeyId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/externaldataquery/api/import/journey/{journeyId}/latestImport'.replace('{journeyId}', journeyId);
...
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/externaldataquery/api/mapping/provider/{providerId}'.replace('{providerId}', providerId);
requestOptions.qs = { entityType: base.getNodeParameter('entityType', 0) as string };
break;
case 'GetMappingConfiguration': 
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/externaldataquery/api/mapping/configuration';
requestOptions.qs = { entityType: base.getNodeParameter('entityType', 0) as string };
break;
case 'GetSubscriptionsByEntityId': entityId = base.getNodeParameter('entityId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/externaldataquery/api/ongoingmonitoring/subscriptions/entity/{entityId}'.replace('{entityId}', entityId);

break;
case 'GetSearchResultsById': id = base.getNodeParameter('id', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/externaldataquery/api/search/{id}'.replace('{id}', id);

break;
case 'GetSearchResultsByJourneyId': journeyId = base.getNodeParameter('journeyId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/externaldataquery/api/search/journey/{journeyId}'.replace('{journeyId}', journeyId);
requestOptions.qs = { fromInternalProviders: base.getNodeParameter('fromInternalProviders', 0) as string };
break;
}

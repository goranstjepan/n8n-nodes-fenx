...
requestOptions.uri = 'https://api.fenergox.com/businessmetricsquery/api/journeycompletedelapsedtimedaily';

break;
case 'GetJourneyCompletedDailyRecordsByDateRange': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.fenergox.com/businessmetricsquery/api/journeycompletedelapsedtimedaily/getjourneycompletedtimedailyrecordsbydaterange';
